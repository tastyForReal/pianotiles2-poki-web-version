(function () {
  function boot() {
    ...
    var onStart = function () {
      ...
      if (!false && !false) {
        ...
        if (cc.sys.isMobile) {
          ...
          if (/qukan/i.test(navigator.userAgent)) {
      ...
      if (false) {
        cc.Pipeline.Downloader.PackDownloader._doPreload(
          'WECHAT_SUBDOMAIN',
          settings.WECHAT_SUBDOMAIN_DATA,
        );
      }
    ...
    if (cc.sys.isNative && cc.sys.isMobile) {
      jsList = jsList.concat([
        'src/anysdk/jsb_anysdk.js',
        'src/anysdk/jsb_anysdk_constants.js',
      ]);
    }
