!(function (n) {
      ...
      serialize: function (e) {
        ...
        if (e instanceof Array) {
          for (var o = 0; o < e.length; o++)
            void 0 !== e[o] &&
              n.push('object' == i(e[o]) ? '' : this.serialize(e[o]));
          return n.join('|');
        }
        for (var o in e)
          void 0 !== e[o] &&
    ...
    e.exports = {
      setStorage: function (e, t, n) {
        ...
        try {
          ...
          return (
            (r.default.tempUserLoginInfo[e] = t),
            (r.default.tempUserLoginInfo[e + '_expiresIn'] = o),
            !1
          );
        }
        return !0;
  ...
  function (e, t, n) {
    ...
    var o = function () {
      var r =
        0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 'GET';
      return function (o, i) {
        return new Promise(function (t, n) {
          var e = {
            url: o,
    ...
    (n.Report = function (t, n, o) {
      ...
      if ('SceneFlow' == t) {
        ...
        if (
          ...
          null == u.vRoleID && '' == u.vRoleID
            ? (s.vRoleID = -1)
            : (s.vRoleID = u.vRoleID),
          u.combatEffectiveness &&
            (s.CombatEffectiveness = u.combatEffectiveness),
      ...
      if (
        ...
        (y.reportType = t),
        m.push(y),
        m.length > S.default.reportCount)
      )
        return (
          (0, I.reportIdata)(m)
            .then(function (t) {
    ...
    e.exports = {
        ...
        return new Promise(function (n, o) {
          (function t() {
            wx.login({
              ...
              fail: function (e) {
                i.reportLoginFail(1, e.errMsg),
                  /timed\sout/.test(e.errMsg) ||
                  /failed\sto\sconnect\sto/.test(e.errMsg)
      ...
      reportLoginFail: function (e, t) {
        ...
        null == n.query.openid ||
          ...
          ((o.shareOpenid = n.query.openid),
          (o.shareStatus = 13 == n.query.shareStatus ? 13 : -1));
        var i = [o];
        (0, c.reportIdata)(i)
          .then(function (e) {})
          .catch(function (e) {
  ...
  function (e, t, n) {
    ...
    e.exports = {
      ...
      openTencentGameContract: function () {
        'function' == typeof wx.openTencentGameContract &&
          wx.openTencentGameContract();
      },
      openTencentPrivacyContract: function () {
        'function' == typeof wx.openTencentPrivacyContract &&
    ...
    e.exports = {
        ...
        wx.showShareMenu({
          ...
          wx.onShareAppMessage(function (e) {
            var t = {},
              n = o;
            if (
              ('function' == typeof o && (n = o()), 'object' == i(n.shareInfo))
            )
              return (
      ...
      shareMessage: function (t) {
        ...
        (e.title = t.shareInfo.title),
          null != t.shareInfo.imageUrl &&
            '' != t.shareInfo.imageUrl &&
            (e.imageUrl = t.shareInfo.imageUrl),
          null != t.shareInfo.query && '' != t.shareInfo.query
            ? (e.query =
                t.shareInfo.query + '&openid=' + a.default.getStorage('openid'))
            : (e.query = 'openid=' + a.default.getStorage('openid')),
          null != t.shareInfo.canvas &&
            '' != t.shareInfo.canvas &&
      ...
      getLoginKey: function (e, t) {
        ...
        return (
          null == o.query.openid ||
            ...
            ((i.shareOpenid = o.query.openid),
            (i.shareStatus = 13 == o.query.shareStatus ? 13 : -1)),
              ...
              : (0, u.get)(r.default.api, i)
                  .then(function (e) {
                    if (
                      ...
                      var t = e.data;
                      s.default.setStorage(
                        'sdkKey',
                        t.list.h5sdk_sessionid,
                        86400,
                      ),
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', {
      ...
      (t.shareReport = function (e) {
        ...
        return (
          2 == e.shareMode &&
            (o.scene = null == e.gameScene ? -1 : e.gameScene),
          new Promise(function (t, n) {
            o.appid.length < 3
              ? n({
                  data: {
