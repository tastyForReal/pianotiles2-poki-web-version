...
(function (t) {
    ...
    var t = (function () {
      ...
      return (
        ...
        (t.prototype.init = function (t, e) {
          return this.mbInited
            ...
            : ((this.mPlatFormType = t.getPlatformType()),
              (this.mAdInterceptor = new i.MGBAdInterceptor(
                this.mPlatFormType,
              )),
              (this.mAdEnvCfg = t),
        ...
        (t.prototype.getPosIdCfg = function (t) {
          return null == t
            ? null
            : null == this.mDepotPosIdCfg
            ? null
            : this.mDepotPosIdCfg.getPosIdCfg(t);
        }),
        (t.prototype.fetchAd = function (t, e, o) {
          if (!this.mAdInterceptor || this.mAdInterceptor.intercept())
            return (
              i.Log.e(
                this.TAG,
                'intercept ad fetch request because of unsupported platform',
              ),
              new i.ResultFetchAd(
                i.MGBAdErrCode.ADERR_ADMODULE_PLATFORM_INTERCEPT,
              )
            );
          if (this.hasSceneExitFlag(t))
            return new i.ResultFetchAd(i.MGBAdErrCode.ADERR_ADM_EXIT_SCENE);
          var n = this.getAdDepot(t);
          return null == n
            ? new i.ResultFetchAd(
                i.MGBAdErrCode.ADERR_ADMODULE_FETCH_NO_ADDEPOT,
              )
            : n.doFetch(e, o);
        }),
        (t.prototype.loadAd = function (t, e, o) {
          if (!this.mAdInterceptor || this.mAdInterceptor.intercept())
            return (
              i.Log.e(
                this.TAG,
                'intercept ad load request because of unsupported platform',
              ),
              i.MGBAdErrCode.ADERR_ADMODULE_PLATFORM_INTERCEPT
            );
          var n = this.getAdDepot(t);
  ...
  (function (s) {
    var t = (function () {
      function t() {
        (this.TAG = 'MGB_MGBAdProvider4FBInterstitial'),
          (this.mAdCache = new s.MGBAdCache());
      }
      return (
        ...
        (t.prototype.doLoad = function (e, t, o, n) {
          ...
          return null == t
            ? (s.Log.e(
                this.TAG,
                'facebook interstitial ad require Placement ID',
              ),
            ...
            : (s.Log.i(
                this.TAG,
                'facebook interstitial start doLoad, posId = ' + e.getPosId(),
              ),
              FBInstant.getInterstitialAdAsync(t)
                ...
                .then(function () {
                  s.Log.i(
                    i.TAG,
                    'Preload FB interstitial successfully, posId = ' +
                      e.getPosId(),
                  ),
                    MGRPT.minigame_common_ad.report(
                      e.getPosId(),
                  ...
                  i.mAdCache.pushBack(t),
                    s.Log.i(
                      i.TAG,
                      'Current facebook interstitial ad cache size: ' +
                        i.mAdCache.getSize(),
                    ),
                    n && n.onSuccess();
                })
        ...
        (t.prototype.doFetch = function (t, e, o, n) {
          if (null == t)
            return new s.ResultFetchAd(
              s.MGBAdErrCode.ADERR_AP_FETCH_ARGS_ERROR,
            );
          if (!e)
            return (
              s.Log.e(
          ...
          return (
            this.isNeedLoadMore() &&
              this.doLoad(t, e, new s.ParamAdLoad(), null),
            null == r
              ? (MGRPT.minigame_common_ad.report(
                  t.getPosId(),
                  s.MGBAdAction.ACTION_AP_FETCH_FAILED,
  ...
  (function (s) {
    var t = (function () {
      function t() {
        (this.TAG = 'MGB_MGBAdProvider4FBRewardVideo'),
          (this.mAdCache = new s.MGBAdCache());
      }
      return (
        (t.prototype.getAPName = function () {
        ...
        (t.prototype.doLoad = function (e, t, o, n) {
          ...
          return null == t
            ...
            : (s.Log.i(
                this.TAG,
                'facebook video start doLoad, posId = ' + e.getPosId(),
              ),
              FBInstant.getRewardedVideoAsync(t)
                ...
                .then(function () {
                  s.Log.i(
                    i.TAG,
                    'Preload FB video successfully, posId = ' + e.getPosId(),
                  ),
                    MGRPT.minigame_common_ad.report(
                      e.getPosId(),
                      s.MGBAdAction.ACTION_AP_LOAD_SUCCESS,
                  ...
                  i.mAdCache.pushBack(t),
                    s.Log.i(
                      i.TAG,
                      'Current facebook video ad cache size: ' +
                        i.mAdCache.getSize(),
                    ),
                    n && n.onSuccess();
                })
  ...
  (function (a) {
    var t = (function () {
      function t() {
        (this.TAG = 'MGB_AdProvider4QQBanner'),
      ...
      return (
        ...
        (t.prototype.doLoad = function (r, t, e, i) {
          ...
          return null == r
            ...
            : (a.Log.i(this.TAG, 'start doLoad, posId = ' + r.getPosId()),
              null == t &&
                a.Log.i(this.TAG, "QQ banner doesn't require native posid"),
              null == r
                ...
                : (MGRPT.minigame_common_ad.report(
                  ...
                  BK.Advertisement.fetchBannerAd(function (t, e, o) {
                    if (
                      (a.Log.i(s.TAG, 'BK Ad fetchBannerAd callback', t),
                      0 == t)
                    ) {
                      a.Log.i(
                        s.TAG,
                        'load QQ banner successfully, posId = ' + r.getPosId(),
                      ),
                        MGRPT.minigame_common_ad.report(
                          r.getPosId(),
        ...
        (t.prototype.doFetch = function (t, e, o, n) {
          if (null == t)
            return new a.ResultFetchAd(
              a.MGBAdErrCode.ADERR_AP_FETCH_ARGS_ERROR,
            );
          if (
            ...
            return new a.ResultFetchAd(
              a.MGBAdErrCode.ADERR_AP_FETCH_NOAD_INCACHE,
            );
          var r = this.mAdCache.popFront();
          return null == r
  ...
  (function (s) {
    var t = (function () {
      function t() {
        (this.TAG = 'MGB_AdProvider4QQVideo'),
          (this.mAdCache = new s.MGBAdCache());
      }
      return (
        (t.prototype.getAPName = function () {
        ...
        (t.prototype.doLoad = function (r, t, e, i) {
          ...
          if (
            (null == t &&
              s.Log.i(this.TAG, "QQ video doesn't require native posid"),
            null == r)
          )
          ...
          return -1 == o
            ? (s.Log.e(
                this.TAG,
                'MGBAdProvider4QQRewardVideo video type is -1, posId = ' +
                  r.getPosId(),
              ),
              s.MGBAdErrCode.ADERR_AP_LOAD_ARGS_ERROR)
            : (s.Log.i(
                this.TAG,
                'MGBAdProvider4QQRewardVideo start doLoad, posId = ' +
                  r.getPosId(),
              ),
              MGRPT.minigame_common_ad.report(
                r.getPosId(),
              ...
              BK.Advertisement.fetchVideoAd(
                ...
                function (t, e, o) {
                  if (
                    (s.Log.i(this.TAG, 'BK Ad fetchVideoAd callback', t),
                    0 == t)
                  ) {
                    s.Log.i(
                      this.TAG,
                      'load QQ video successfully, posId = ' + r.getPosId(),
                    ),
                      MGRPT.minigame_common_ad.report(
                        r.getPosId(),
                        s.MGBAdAction.ACTION_AP_LOAD_SUCCESS,
        ...
        (t.prototype.doFetch = function (t, e, o, n) {
          if (
            null == t ||
            -1 == t.getNum(s.MGBAdPosIdCfg.KEY_AP4QQVIDEO_TYPE, -1)
          )
            return new s.ResultFetchAd(
              s.MGBAdErrCode.ADERR_AP_FETCH_ARGS_ERROR,
            );
      ...
      return (
        ...
        (t.prototype.doLoad = function (e, t, o, n) {
          ...
          if (!wx.createBannerAd)
            return A.MGBAdErrCode.ADERR_AP4WXBANNER_LOAD_NO_API;
          ...
          if (null == s)
            return A.MGBAdErrCode.ADERR_AP4WXBANNER_LOAD_NO_ADHANDLER;
          ...
          return (
            s.onResize(function (t) {
              A.Log.i(
                r.TAG,
                'enter wxadHandler.onResize, posId = ' + e.getPosId(),
              ),
                null != t
                  ? null != a
                    ...
                    : A.Log.e(
                        r.TAG,
                        'wxadHandler.onResize  posAdapter != null, posId = ' +
                          e.getPosId(),
                      )
                  : A.Log.e(
                      r.TAG,
                      'wxadHandler.onResize  res == null, posId = ' +
                        e.getPosId(),
                    );
            }),
            s.onLoad(function () {
        ...
        (t.prototype.getWXBAdPosAdapter = function (t) {
          return null == t
            ? null
            : t.getObject(A.MGBAdPosIdCfg.KEY_AP4WXBANNER_POS_ADAPTER, null);
        }),
        (t.prototype.getAdCache = function () {
          return this.mAdCache;
        }),
    ...
    var t = (function () {
      ...
      return (
        ...
        (t.prototype.doLoad = function (n, t, e, r) {
          ...
          return n
            ? t
              ...
              : (s.Log.e(
                  this.TAG,
                  'nativePosId is null, posId = ' + n.getPosId(),
                ),
                s.MGBAdErrCode.ADERR_AP_LOAD_NO_NATIVEPOSID)
            : s.MGBAdErrCode.ADERR_AP_LOAD_NO_POSIDCFG;
        }),
        (t.prototype.doFetch = function (t, e, o, n) {
          if (!t)
            return new s.ResultFetchAd(
              s.MGBAdErrCode.ADERR_AP_FETCH_NO_POSIDCFG,
            );
          if (!e)
            return (
          ...
          if (null != o) {
            ...
            if (null != n) {
              var r = n.screenHeight - e,
                i = (n.screenWidth - t) / 2,
                s = t;
              parseInt(((100 * e) / t).toString()) >
                parseInt((16e3 / 560).toString()) && (s = 300),
                o.setAdPos(i, r, s);
            }
          }
        }),
    ...
    var t = (function () {
      ...
      return (
        ...
        (e.prototype.onShow = function (t) {
          this.mClickCallback &&
            this.mClickCallback.onShowFinish(null, null, null);
        }),
        ...
        (e.prototype.unregClickCallback = function (t) {
          t &&
            (this.mPosIdCur == t
              ...
              : o.Log.e(
                  e.TAG,
                  '[unregClickCallback] ERROR mPosIdCur:' +
                    this.mPosIdCur +
                    ', posId:' +
                    t,
                ));
    ...
    var t = (function () {
      function n() {
        (this.mWXAdHandler = null),
          (this.mCacheStatus = 0),
          (this.mCacheStatus = n.STATUS_CACHE_NONE);
      }
      return (
        ...
        (n.prototype.load = function (e, t, o) {
          this._init(t),
            this.mWXAdHandler
              ...
              : o &&
                o.onFailed(
                  r.MGBAdErrCode.ADERR_AP4WXVIDEO_LOAD_NO_ADHANDLER,
                  0,
                  0,
                );
        }),
        (n.prototype.fetch = function (t, e) {
          return (
            ...
            this.hasCache()
              ? ((this.mCacheStatus = n.STATUS_CACHE_NONE), this.mWXAdHandler)
              : null
          );
        }),
        ...
        (n.prototype.onAdLoad = function () {
          (this.mCacheStatus = n.STATUS_CACHE_ENOUGH),
            r.Log.i(
              n.TAG,
              'WX reward video load success. mCacheStatus:' + this.mCacheStatus,
            );
        }),
    ...
    var t = (function () {
      ...
      return (
        ...
        (t.prototype.isCurValid = function () {
          return (
            null !== this.mInterstitialAdInstance &&
            void 0 !== typeof this.mInterstitialAdInstance
          );
        }),
          ...
          if (this.mInterstitialAdInstance) {
            ...
            this.mInterstitialAdInstance
              ...
              .catch(function (t) {
                n.Log.e(
                  o.TAG,
                  'FB interstitial ad show failed, errInfo:' +
                    t.code +
                    ', ' +
                    t.message,
                ),
            ...
            n.Log.w(
              this.TAG,
              'FB interstitial ad show failed since adInstance not initialized',
            ),
  ...
  (function (n) {
    var t = (function () {
      ...
      return (
        ...
        (t.prototype.isCurValid = function () {
          return (
            null !== this.mVideoAdInstance &&
            void 0 !== typeof this.mVideoAdInstance
          );
        }),
        (t.prototype.show = function (e) {
          if (this.mVideoAdInstance) {
            ...
            this.mVideoAdInstance
              ...
              .catch(function (t) {
                n.Log.e(
                  o.TAG,
                  'FB Rewarded video show failed, errInfo:' +
                    t.code +
                    ', ' +
                    t.message,
                ),
            ...
            n.Log.w(
              this.TAG,
              'FB Rewarded video show failed since adInstance not initialized',
            ),
              e && e.onShowFail(this, null, null);
        }),
        (t.prototype.doRptAdShow = function () {
    ...
    var t = (function () {
      ...
      return (
        ...
        (t.prototype.show = function (n) {
          ...
          i.Log.i(
            this.TAG,
            'ready to show QQ banner ad, posId = ' + this.mPosIdCfg.getPosId(),
          ),
            this.mBannerHandler &&
              this.mBannerHandler.show(function (t, e, o) {
                if (0 == t) {
                  if (
                    (i.Log.i(
                      r.TAG,
                      ' QQ banner show success, posId = ' +
                        r.mPosIdCfg.getPosId(),
                    ),
                    i.MGBAdModule.getInstance().hasSceneExitFlag(
                      r.mPosIdCfg.getPosId(),
                    ))
                  )
                    return (
  ...
  (function (r) {
    var t = (function () {
      ...
      return (
        ...
        (t.prototype.isCurValid = function () {
          return (
            null !== this.mVideoAdHandler &&
            void 0 !== typeof this.mVideoAdHandler
          );
        }),
      ...
      return (
        ...
        (t.prototype.destroy = function () {
          this.unRegClickCallback(),
            null != this.mWXAdHandler &&
              (this.mWXAdHandler.hide(), this.mWXAdHandler.destroy());
        }),
        ...
        (t.prototype.show = function (e) {
          ...
          if (this.mPosIdCfg && this.mPosIdCfg.getPosId()) {
            if (
              n.MGBAdModule.getInstance().hasSceneExitFlag(
                this.mPosIdCfg.getPosId(),
              )
            )
            ...
            n.WXBannerAdMonitor.getInstance().regClickCallback(
              this.mPosIdCfg.getPosId(),
              e,
            );
          }
          n.Log.i(
            this.TAG,
            'ready to show WX banner ad, posId = ' + this.mPosIdCfg.getPosId(),
          ),
            this.mWXAdHandler &&
              this.mWXAdHandler
                .show()
        ...
        (t.prototype.hide = function () {
          this.unRegClickCallback(),
            this.mWXAdHandler && this.mWXAdHandler.hide();
        }),
        (t.prototype.unRegClickCallback = function () {
          this.mPosIdCfg &&
            this.mPosIdCfg.getPosId() &&
            n.WXBannerAdMonitor.getInstance().unregClickCallback(
              this.mPosIdCfg.getPosId(),
            );
        }),
        t
    ...
    var t = (function () {
      ...
      return (
        ...
        (t.prototype.show = function (t) {
          ...
          this.mPosIdCfg &&
          this.mPosIdCfg.getPosId() &&
          o.MGBAdModule.getInstance().hasSceneExitFlag(
            this.mPosIdCfg.getPosId(),
          )
            ? MGRPT.minigame_common_ad.report(
                this.mPosIdCfg.getPosId(),
                ...
                this.mWXAdHandler
                  ...
                  .then(function () {
                    e.mPosIdCfg &&
                      ...
                      e.mAdShowCallback &&
                        e.mAdShowCallback.onShowSuccess(e, null, null);
                  })
                  .catch(function (t) {
                    e.mPosIdCfg &&
                      MGRPT.minigame_common_ad.report(
                      ...
                      e.mAdShowCallback &&
                        e.mAdShowCallback.onShowFail(e, null, null),
            ...
            null != this.mAdShowCallback &&
              ((t && t.isEnded) || void 0 === t
                ? (this.mPosIdCfg &&
                  ...
                  o.Log.i(
                    this.TAG,
                    '正常播放结束，可以下发游戏奖励, posId = ' +
                      this.mPosIdCfg.getPosId(),
                  ),
                  this.mAdShowCallback &&
                    this.mAdShowCallback.onShowFinish(this, null, null))
                : (this.mPosIdCfg &&
                    MGRPT.minigame_common_ad.report(
                      this.mPosIdCfg.getPosId(),
                  ...
                  o.Log.i(
                    this.TAG,
                    '播放中途退出，不下发游戏奖励, posId = ' +
                      this.mPosIdCfg.getPosId(),
                  ),
                  this.mAdShowCallback &&
                    this.mAdShowCallback.onShowUnFinish(this, null, null)),
              (this.mAdShowCallback = null));
        }),
        t
      );
      ...
      return (
        (n.prototype.fetchAd = function (t, e) {
          if ((this.prepareAdProviders(), null == this.mAdProvider))
            return new r.ResultFetchAd(
              r.MGBAdErrCode.ADERR_AS_FETCH_NO_ADPROVIDER,
            );
          if (null == this.mPosIdCfg)
            return new r.ResultFetchAd(
              r.MGBAdErrCode.ADERR_AS_FETCH_NO_POSIDCFG,
            );
        ...
        (n.prototype.loadAd = function (t, e) {
          ...
          if (null == this.mPosIdCfg)
            return r.MGBAdErrCode.ADERR_AS_LOAD_NO_POSIDCFG;
          var o = this.mPosIdCfg.getNativePosId();
        ...
        (n.prototype.getCurSelAdType = function () {
          return (
            ...
            this.mAdProvider
              ? this.mAdProvider.getAdType()
              : r.MGBAdDefs.ADTYPE_UNKNOWN
          );
        }),
        (n.prototype.prepareAdProviders = function () {
          if (null == this.mAdProvider && null != this.mPosIdCfg) {
            ...
            -1 != t
              ? ((this.mAdProvider = this.instanceProvider(
                  this.mPlatformType,
                  t,
                )),
                null != this.mAdProvider ||
                  r.Log.e(
                    this.TAG,
                    "didn't find match adprovider for " +
                      this.mPlatformType +
                      ' / ' +
                      t,
                  ))
        ...
        (n.prototype.getCacheSize = function () {
          return (
            ...
            null == this.mAdProvider
              ? (r.Log.e(
                  this.TAG,
                  'MGBAdSelector4Auto this.mAdProvider == null.',
                ),
                0)
          ...
          switch (t) {
            case r.MGBAdDefs.PLATFORM_WX:
              n.ADTYPE_BANNER == e
                ...
                : n.ADTYPE_REWARD_VIDEO == e &&
                  (o = r.MGBAdProvider4WXRewardVideo.APNAME);
              break;
            case r.MGBAdDefs.PLATFORM_QQ:
              n.ADTYPE_BANNER == e
                ? (o = r.MGBAdProvider4QQBanner.APNAME)
                : n.ADTYPE_REWARD_VIDEO == e &&
                  (o = r.MGBAdProvider4QQRewardVideo.APNAME);
              break;
            case r.MGBAdDefs.PLATFORM_FB:
              n.ADTYPE_BANNER == e
                ...
                : n.ADTYPE_REWARD_VIDEO == e &&
                  (o = r.MGBAdProvider4FBRewardVideo.APNAME);
          }
    ...
    var t = (function () {
      ...
      return (
        (t.prototype.fetchAd = function (t, e) {
          if ((this.prepareAdProviders(), null == this.mAdProvider))
            return new n.ResultFetchAd(
              n.MGBAdErrCode.ADERR_AS_FETCH_NO_ADPROVIDER,
            );
          if (null == this.mPosIdCfg)
            return new n.ResultFetchAd(
              n.MGBAdErrCode.ADERR_AS_FETCH_NO_POSIDCFG,
            );
          var o = this.mPosIdCfg.getNativePosId();
          return this.mAdProvider.doFetch(this.mPosIdCfg, o, t, e);
        }),
        (t.prototype.loadAd = function (t, e) {
          ...
          if (null == this.mPosIdCfg)
            return n.MGBAdErrCode.ADERR_AS_LOAD_NO_POSIDCFG;
          var o = this.mPosIdCfg.getNativePosId();
          return this.mAdProvider.doLoad(this.mPosIdCfg, o, t, e);
        }),
        (t.prototype.prepareAdProviders = function () {
          if (null == this.mAdProvider && null != this.mPosIdCfg) {
            var t = this.mPosIdCfg.getStr(
              n.MGBAdPosIdCfg.KEY_ADPROVIDER_NAME,
              '',
            );
            null != t &&
              ((this.mAdProvider =
                n.MGBAdCompFactory.getInstance().createAP(t)),
              this.mAdProvider);
          }
        }),
      ...
      return (
        (t.prototype.saveGames = function (t) {
          if (t) {
            ...
            i.Log.i(
              this.TAG,
              'mListRcmdDest.size:' + this.mListRcmdDest.length,
            );
          }
        }),
        (t.prototype.getItem = function (t) {
          return 0 == this.mListRcmdDest.length ||
            t < 0 ||
            t >= this.mListRcmdDest.length
            ? null
          ...
          if (t)
            for (var e = 0, o = Object.keys(t); e < o.length; e++) {
              ...
              if (n) {
                var r = t[n];
                (this.mapImgUrls[n] = r),
                  i.Log.i(this.TAG, 'imgurls flag[' + n + ']: ' + r);
              }
            }
        }),
    ...
    var t = (function () {
      ...
      return (
        (i.prototype.loadFromNet = function (t, o) {
          ...
          if (!e || 0 == e.length)
            return (
              s.Log.e(i.TAG, 'urlDest is empty.'), void (o && o.onFailed())
            );
        ...
        (i.prototype.prepareUrl = function (t) {
          ...
          return (
            e || (e = s.MGBRcmdDefs.HOST),
            e + t + '/rcmdtype_' + this.getRcmdType() + '.json'
          );
        }),
        (i.TAG = 'MGB_MGBRcmd'),
        i
    ...
    var t = (function (t) {
      ...
      return (
        ...
        (o._saveData2Cache = function (t) {
          if (!t) return !1;
          (o.sRcmdTypeData = t),
            o.sGameDepot || (o.sGameDepot = new n.MGBGameDepot());
    ...
    var t = (function (e) {
      ...
      return (
        ...
        (r._saveData2Cache = function (t) {
          if (!t) return !1;
          (r.sRawJsonData = t),
            r.sGameDepot || (r.sGameDepot = new i.MGBGameDepot());
        ...
        (r.prototype.getRCmdGamePosCur = function () {
          return (
            this.mbGetStartPos ||
              ((this.mCurPos = this.getStartPos()), (this.mbGetStartPos = !0)),
            this.mCurPos
          );
        }),
        ...
        (r.prototype.getStartPos = function () {
          ...
          for (var e = 0, o = t; e < o.length; e++) {
            var n = o[e];
            if (n && n.posid && n.posid == this.mPosId)
              return n.start_pos ? n.start_pos : 0;
          }
          return 0;
        }),
    ...
    var t = (function (e) {
      ...
      return (
        ...
        (s._saveData2Cache = function (t) {
          ...
          (s.sRawJsonData = t),
            s.sGameDepot || (s.sGameDepot = new a.MGBGameDepot());
          var e = s.sRawJsonData.games;
          e && s.sGameDepot.saveGames(e);
          var o = s.sRawJsonData.img4flag;
          return (
            o &&
              (s.sImg4Flags || (s.sImg4Flags = new a.MGBImg4Flag()),
              s.sImg4Flags.saveImgUrls(o)),
            !0
          );
        }),
        ...
        (s.prototype.getSize = function () {
          return this.isDataCached()
            ? (this._savePosIdCfg(),
              this.mGameSelected ? Object.keys(this.mGameSelected).length : 0)
            : 0;
        }),
        ...
        (s.prototype.jump = function (t, e) {
          ...
          if (!r)
            return (
              a.Log.e(
                s.TAG,
                'No Game. jump_idxGS[' + t + ']_gameIdx[' + n + ']',
              ),
              !1
            );
          MGRPT.minigame_common_ad.report(
        ...
        (s.prototype.getGameIdx = function (t) {
          return t < 0 || !this.mGameSelected || t >= this.mGameSelected.length
            ? -1
          ...
          t &&
            (this.mGameSelected && 0 < this.mGameSelected.length
              ...
              : ((this.mGameSelected = t),
                a.Log.i(
                  s.TAG,
                  '_saveGameSel size:' + this.mGameSelected.length,
                )));
        }),
  ...
  (function (t) {
    var e = (function () {
      ...
      return (
        ...
        (t.HOST =
          'https://piano-weixin-game.cmcm.com/pianotiles2/cfg/game_rcmd/'),
        t
      );
    })();
    t.MGBRcmdDefs = e;
          ...
          if (t)
            for (var e in t)
              (this.mapRewards[e] = t[e]),
                o.Log.i(
                  '[MGB_ROM] in _saveRewards, key:' + e + ', count:' + t[e],
                );
        }),
        t
      );
      ...
      return (
        (o.getPlatformType = function () {
          return o.mPlatformTypeCur
            ...
            : (o.prepareGECur(),
              o.mGameEngineCur
                ? (o.mPlatformTypeCur = o.mGameEngineCur.getPlatformType())
                : '');
        }),
        (o.isPlatformWX = function () {
          return (
            o.prepareGECur(),
            !!o.mGameEngineCur && o.mGameEngineCur.isPlatformWX()
          );
        }),
        (o.isPlatformQQ = function () {
          return (
            o.prepareGECur(),
            !!o.mGameEngineCur && o.mGameEngineCur.isPlatformQQ()
          );
        }),
        (o.isPlatformWeb = function () {
          return (
            o.prepareGECur(),
            !!o.mGameEngineCur && o.mGameEngineCur.isPlatformWeb()
          );
        }),
        (o.isPlatformFB = function () {
          return (
            o.prepareGECur(),
            !!o.mGameEngineCur && o.mGameEngineCur.isPlatformFB()
          );
        }),
        (o.setLocalItem = function (t, e) {
          o.prepareGECur(),
            o.mGameEngineCur && o.mGameEngineCur.setLocalItem(t, e);
        }),
        (o.getLocalItem = function (t) {
          o.prepareGECur(),
            o.mGameEngineCur && o.mGameEngineCur.getLocalItem(t);
        }),
        (o.removeLocalItem = function (t) {
          o.prepareGECur(),
            o.mGameEngineCur && o.mGameEngineCur.removeLocalItem(t);
        }),
        (o.clear = function () {
      ...
      return (
        (t.prototype.getSize = function () {
          return (
            ...
            null == this.mAdCache ? 0 : this.mAdCache.length
          );
        }),
        ...
        (t.prototype.removeInvalidCache = function () {
          if (null != this.mAdCache && 0 != this.mAdCache.length)
            for (
              var t = !1, e = 0, o = ((t = !1), this.mAdCache.length);
              e < o;
              t ? e : e++
            ) {
        ...
        (t.prototype.createAP = function (t) {
          if (null == t || !this.mMapId2APCreator.has(t))
            return (
              o.Log.e(
                this.TAG,
                'apName is not registered to MGBAdCompFactory.',
              ),
              null
            );
      ...
      return (
        ...
        (t.prototype.doFetch = function (t, e) {
          if ((this.prepareAdSelector(), null == this.mAdSelector))
            return new n.ResultFetchAd(
              n.MGBAdErrCode.ADERR_DEPOT_FETCH_NO_ADSELECTOR,
            );
          null == t && (t = new n.ParamAdFetch()), this.destoryLastAd();
          var o = this.mAdSelector.fetchAd(t, e);
          return (
            null != o &&
              o.mAdErrCode == n.MGBAdErrCode.ADERR_SUCCESS &&
              (this.mAdLast = o.getAd()),
            o
          );
        }),
        (t.prototype.prepareAdSelector = function () {
          if (null == this.mAdSelector && null != this.mPosIdCfg) {
            var t = this.mPosIdCfg.getStr(
              n.MGBAdPosIdCfg.KEY_ADSELECTOR_NAME,
              '',
            );
            (null != t && 0 != t.length) ||
              n.Log.e(this.TAG, 'posId: asName == null'),
              (this.mAdSelector = n.MGBAdCompFactory.getInstance().createAS(
                t,
                this.mPosIdCfg,
              ));
          }
        ...
        (t.prototype.getCacheSize = function () {
          return (
            ...
            null == this.mAdSelector
              ? (n.Log.e(
                  'MGB_DEBUG',
                  'MGBAdDepot.getCacheSize: this.mAdSelector == null',
                ),
                0)
        ...
        (t.prototype.destoryLastAd = function () {
          null != this.mAdLast &&
            (this.mAdLast.destroy(), (this.mAdLast = null));
        }),
        (t.prototype.getAdType = function () {
          return (
            this.prepareAdSelector(),
            this.mAdSelector
              ? this.mAdSelector.getCurSelAdType()
              : n.MGBAdDefs.ADTYPE_UNKNOWN
          );
        }),
        t
    ...
    var t = (function () {
      ...
      return (
        ...
        (t.prototype.intercept = function () {
          if (!this.mbEnableAdOutSide)
            return e.Log.e(this.TAG, 'MGBAd SDK is disable'), !0;
          ...
          return (
            t &&
              t.forEach(function (t) {
                if ('getRewardedVideoAsync' === t)
                  return (e.mFaceBookVideoAPI = t), !0;
              }),
            !1
          );
        }),
        (t.prototype.isWXSDKVersionValid = function () {
          return (
            wx.getSystemInfoSync().SDKVersion >= this.VALID_WXAD_SDKVERSION
          );
        }),
        t
      );
    ...
    var t = (function (o) {
      function n(t) {
        ...
        return (
          ...
          e.setStr(
            r.MGBAdPosIdCfg.KEY_ADSELECTOR_NAME,
            r.MGBAdSelector4Auto.ASNAME,
          ),
          e
        );
      }
      return (
        ...
        (n.prototype.getNativePosId = function () {
          ...
          return t && 0 < t.length
            ? t
            : r.PlatformProxy.getInstance().getNativePosId(this);
        }),
        (n.KEY_POSID = 1),
        (n.KEY_ADTYPE = 2),
    ...
    var e = (function () {
      ...
      return (
        ...
        (t.prototype.getPosIdCfg = function (t) {
          return null == t
            ? null
            : this.mMapId2Cfg.has(t)
            ? this.mMapId2Cfg.get(t)
            : null;
        }),
        t
      );
  ...
  (function (e) {
    var t = (function () {
      function t(t) {
        (this.mAd = null),
          (this.mAdErrCode = e.MGBAdErrCode.ADERR_UNKNOWN),
          (this.mAdErrCode = t);
      }
      return (
    ...
    var t = (function () {
      ...
      return (
        ...
        (t.prototype.request = function (n, t) {
          ...
          for (var e in (i.open(n.method, n.url), n.header))
            i.setRequestHeader(e, n.header[e]);
          (i.onreadystatechange = function () {
            if (i.readyState == XMLHttpRequest.DONE)
              if (
                ...
                if (
                  (s.Log.i(r.TAG, 'facebook request, succeed:', i.responseText),
                  n.success)
                ) {
                  var e = i.status,
                ...
                s.Log.i(r.TAG, 'facebook request, failed:', i.responseText),
                  1 < t
                    ? r.request(n, t - 1)
                    : n.fail && n.fail(i.status, i.responseText);
          }),
    ...
    var t = (function () {
      ...
      return (
              ...
              if (n.success)
                if ('json' == n.dataType)
                  try {
                    ...
                    d.Log.e(a.TAG, 'success 2. rsp:' + o),
                      n.success(e, o, null);
                  }
                else n.success(e, o, null);
            } else if ((d.Log.e(a.TAG, 'code(' + e + ') != 200'), 0 < r))
              i.request(n, r - 1);
            else if (n.fail)
              if ('json' == n.dataType)
                try {
        ...
        (a.prototype.skipGame = function (t, e, o) {
          if (!BK.QQ.skipGame)
            return (
              d.Log.i(a.TAG, 'BK.QQ.skipGame undefined.'),
              o && o.fail && o.fail(null),
              !1
            );
          ...
          return (
            ...
            d.Log.i(
              a.TAG,
              'after call BK.QQ.skipGame. gameid_qq:' + e.gameidQQ,
            ),
        ...
        (a.getDataPath = function () {
          BK.FileUtil.isFileExist(a.DATA_DIR) ||
            BK.FileUtil.makeDir(a.DATA_DIR);
        ...
        (d.prototype.skipGame = function (t, e, o) {
          ...
          var a = {
            ...
            success: function (t) {
              A.Log.i(
                d.TAG,
                'navigateToMiniProgram success(). res:' + JSON.stringify(t),
              ),
            ...
            fail: function (t) {
              A.Log.i(
                d.TAG,
                'navigateToMiniProgram fail(). res:' + JSON.stringify(t),
              ),
                o && o.fail && o.fail(t);
            },
            complete: function (t) {
              A.Log.i(
                d.TAG,
                'navigateToMiniProgram complete(). res:' + JSON.stringify(t),
              );
            },
          };
        ...
        (t.prototype.request = function (n, t) {
          ...
          (i.onreadystatechange = function () {
            if (4 == i.readyState)
              if (200 == i.status) {
                if (
                  (s.Log.i(r.TAG, 'request, succeed:', i.responseText),
                  n.success)
                ) {
                  var e = i.status,
                    o = i.getAllResponseHeaders();
    ...
    var t = (function () {
      ...
      return (
        ...
        (t.prototype.request = function (t, e) {
          void 0 === e && (e = 3),
            this.mPlatformCur
              ? this.mPlatformCur.request(t, e)
              : t && t.fail && t.fail(0, null);
        }),
        (t.prototype.getPlatformInfo = function () {
        ...
        (t.prototype.skipGame = function (t, e, o) {
          return (
            void 0 === o && (o = null),
            !!this.mPlatformCur && this.mPlatformCur.skipGame(t, e, o)
          );
        }),
        (t.prototype.getNativePosId = function (t) {
  ...
  (function (t) {
    ...
    function r(t) {
      for (
        var e, o = i ? '0123456789ABCDEF' : '0123456789abcdef', n = '', r = 0;
        r < t.length;
        r++
      )
        (e = t.charCodeAt(r)),
    ...
    function d(t, e) {
      ...
      for (o = 0; o < d.length; o++)
        d[o] = (t.charCodeAt(2 * o) << 8) | t.charCodeAt(2 * o + 1);
      for (; 0 < d.length; ) {
