...
(function (e) {
        ...
        var e = (function () {
            ...
            return (
                            ...
                            callback: function (t, r, e, a) {
                                if (t && n.checkAuthorization) {
                                    if (!a || (!a.Authorization && !a.authorization))
                                        return (
                                            i.Platform.error('AdapterWX networkRequest, fail: Authorization is empty.'),
                                            void n.callback(!1, r)
                                        );
                                    var o = '';
                                    if (
                                    ...
                                    i.Platform.log('AdapterWX networkRequest, The authorization is right.');
                                }
                ...
                (e.prototype.reportShare = function (e, t, r, a) {
                    void 0 === r && (r = 5),
                        void 0 === a && (a = 5),
                        i.CloudUtil.reportShare(i.CloudUtil.SHARE_REPORT_WX, e, t, !0, r, a);
                }),
                (e.prototype.reportShareCompetition = function (e, t, r, a, o) {
                    void 0 === r && (r = 3),
                        void 0 === a && (a = 99),
                        void 0 === o && (o = '2200'),
                        i.CloudUtil.reportShare(i.CloudUtil.SHARE_REPORT_COMPETITION_WX, e, t, !0, r, a, o);
                }),
                (e.prototype.queryShareCompetition = function (e, t) {
                    i.CloudUtil.queryShare(i.CloudUtil.SHARE_QUERY_COMPETITION_WX, e, !0, t);
                }),
                (e.prototype.reportShareSkin = function (e, t, r, a) {
                    void 0 === r && (r = 5),
                        void 0 === a && (a = 99),
                        i.CloudUtil.reportShare(i.CloudUtil.SHARE_SKIN_REPORT_WX, e, t, !0, r, a);
                }),
                ...
                (e.prototype.reportShareHdReport = function (e, t, r, a, o) {
                    i.CloudUtil.reportShareHdReport(i.CloudUtil.SHARE_HD_REPORT_WX, e, t, o, !0, r, a);
                }),
                ...
                (e.prototype.shareQueryBatch = function (e, t) {
                    i.CloudUtil.shareHdQueryBatch(i.CloudUtil.SHARE_HD_QUERY_WX_BATCH, e, t);
                }),
                ...
                (e.prototype.queryMusicPeopleNums = function (e, t) {
                    i.CloudUtil.queryMusicPeopleNums(i.CloudUtil.QUERY_MUSIC_PEOPLE_NUM_WX, e, t);
                }),
                ...
                (e.prototype.saveChallengeRank = function (e, t, r, a, o) {
                    i.CloudUtil.saveChallengeRank(i.CloudUtil.RANK_SAVE_WX, e, t, r, a, o);
                }),
                ...
                (e.prototype.queryChallengeTopSelf = function (e, t, r) {
                    i.CloudUtil.queryChallengeTopSelf(i.CloudUtil.RANK_QUERY_TOP_SELF_WX, e, t, r);
                }),
                (e.prototype.queryChallengeScore = function (e, t, r, a) {
                    i.CloudUtil.queryChallengeScore(i.CloudUtil.RANK_QUERY_SCORE_WX, e, t, r, a);
                }),
                ...
                (e.prototype.checkInBlackList = function (e) {
                    i.CloudUtil.checkInBlackList(i.CloudUtil.CHALLENGE_COMPETITION_BLACK_LIST, e, !0);
                }),
                (e.prototype.queryChallengeSelfRecord = function (e, t, r, a, o) {
                    i.CloudUtil.queryChallengeSelfRecord(i.CloudUtil.RANK_QUERY_SELF_RECORD, e, t, r, a, o);
                }),
                (e.prototype.queryChallengeOtherRecord = function (e, t, r, a, o, n) {
                    i.CloudUtil.queryChallengeOtherRecord(i.CloudUtil.RANK_QUERY_OTHER_RECORD, e, t, r, a, o, n);
                }),
                (e.prototype.queryCooperationScore = function (e, t) {
                    i.CloudUtil.queryCooperationScore(i.CloudUtil.COOPERATION_QUERY_SCORE, e, t);
                }),
                ...
                (e.prototype.queryUserInfoLevel = function (e, t) {
                    i.CloudUtil.queryUserInfoLevel(i.CloudUtil.QUERY_USER_INFO_LEVEL, e, t);
                }),
    ...
    (function (a) {
        var e = (function (t) {
            ...
            return (
                __extends(e, t),
                (e.prototype.init = function (e, t, r) {
                    (this.APPID = e), (this.DebugMode = r), this.DebugMode || a.CloudUtil.useFBServer();
                }),
                (e.prototype.networkRequest = function (t) {
                    a.Platform.log('NetworkUtils requestFB(platform), parameter:' + t.url);
                    var r = new XMLHttpRequest();
                    for (var e in (r.open(t.method, t.url), t.header)) r.setRequestHeader(e, t.header[e]);
                    (r.onreadystatechange = function () {
                        if (4 == r.readyState)
                            if (200 == r.status)
                                if (
                                    (a.Platform.log('NetworkUtils requestFB(platform), success:' + r.responseText),
                                    'json' == t.dataType)
                                )
                                    try {
                                ...
                                a.Platform.log('NetworkUtils requestFB(platform), fail:' + r.responseText),
                                    t.callback(!1, r.responseText);
                    }),
                        r.send(JSON.stringify(t.data));
                }),
                (e.prototype.uploadPlayerFriends = function (e, t) {
                    a.CloudUtil.uploadPlayerFriends(a.CloudUtil.UPLOAD_PLAYER_FRINEDS_FB, e, t);
                }),
                e
            );
        })(a.AdapterWX);
    ...
    (function (n) {
        var e = (function (t) {
            function e() {
                ...
                return (n.CloudUtil.SERVER_ADDRESS_FB = 'http://10.12.32.113:8080/warty/'), e;
            }
            return (
                __extends(e, t),
    ...
    (function (e) {
        var t = (function (a) {
            ...
            return (
                __extends(e, a),
                (e.prototype.init = function (e, t, r) {
                    console.warn('AdapterH5SDK::init => appId(' + e + ') version(' + t + ')'),
                        window.H5SDK.init({
                            wxappid: e,
                            gameVersion: t,
                        }),
        ...
        var e = (function (t) {
            ...
            return (
                ...
                (a.prototype.init = function (e, t, r) {
                    _.Platform.log('[AdapterQQ] GameStatusInfo ' + JSON.stringify(GameStatusInfo)),
                        (this.APPID = e),
                        (this.DebugMode = r);
                }),
                    ...
                    if (_.CloudUtil.sPlayerInfo) {
                        ...
                        if (n && 0 < n.length) {
                            var t = {
                                ...
                                r = 'CMCM ' + _.hex_hmac_sha1(_.CloudUtil.sPlayerInfo.token, JSON.stringify(t)),
                                i = !1,
                            ...
                            this.networkRequest({
                                ...
                                callback: function (e, r) {
                                    if (
                                        (_.Platform.log('[AdapterQQ] uploadFile ' + e + ', ' + JSON.stringify(r)),
                                        e && r && 0 == r.status)
                                    ) {
                                        ...
                                        t.setBodyCompatible(!1),
                                            ...
                                            t.requestAsync(function (e, t) {
                                                _.Platform.log(
                                                    '[AdapterQQ] uploadFile ' + t + ', ' + e.readAsString(!0),
                                                ),
                                                    i ||
                                                        (clearTimeout(l),
                                                        200 == t ? o(0, r.download_url) : o(t, 'COS server error'));
                                            });
                ...
                (a.prototype.calcMd5Base64 = function (e) {
                    for (var t = new Uint8Array(e.length), r = 0; r < t.length; ++r) t[r] = e.readUint8Buffer();
                    var a = new _.Md5();
                    a.appendByteArray(t);
                    var o = a.end(!0);
                    _.Platform.log('[AdapterQQ] md5_hex=' + _.Md5._hex(o)), (t = new Uint8Array(16));
                    for (r = 0; r < 4; r++)
                    ...
                    for (r = 0; r < i; r += 3)
                        for (
                            var l = (t[r] << 16) | (r + 1 < i ? t[r + 1] << 8 : 0) | (r + 2 < i ? t[r + 2] : 0), s = 0;
                            s < 4;
                            s++
                        )
                            8 * r + 6 * s > 8 * t.length
        ...
        var e = (function (e) {
            ...
            return (
                ...
                (t.prototype.networkRequest = function (t) {
                    a.Platform.log('NetworkUtils AdapterQQH5 requestQQH5(platform), parameter:' + t.url);
                    var r = new XMLHttpRequest();
                    for (var e in (r.open(t.method, t.url), t.header)) r.setRequestHeader(e, t.header[e]);
                    (r.onreadystatechange = function () {
                        if (4 == r.readyState)
                            if (200 == r.status)
                                if (
                                    (a.Platform.log(
                                        'NetworkUtils AdapterQQH5 requestQQH5(platform), success:' + r.responseText,
                                    ),
                                    'json' == t.dataType)
                                )
                                    try {
                                ...
                                a.Platform.log(
                                    'NetworkUtils AdapterQQH5 requestQQH5(platform), fail:' + r.responseText,
                                ),
                                    t.callback(!1, r.responseText);
                    }),
                        r.send(JSON.stringify(t.data));
            ...
            return (
                (l.reportScore = function (r, a, o, n, i) {
                    if ((void 0 === i && (i = !0), s.CloudUtil.sPlayerInfo)) {
                        var e = {
                            ...
                            t = 'CMCM ' + s.hex_hmac_sha1(s.CloudUtil.sPlayerInfo.token, JSON.stringify(e));
                ...
                (l.queryFriendsScore = function (r, a, o, n) {
                    if ((void 0 === n && (n = !0), s.CloudUtil.sPlayerInfo)) {
                        s.Platform.log('queryFriendsScore == ' + s.CloudUtil.sPlayerInfo.playerId);
                        var e = {
                                playerid: s.CloudUtil.sPlayerInfo.playerId,
                                timestamp: new Date().getTime(),
                                gameid: s.CloudUtil.GAME_ID,
                ...
                (l.saveWorldRank = function (e, t, r, a, o) {
                    void 0 === o && (o = !0), s.CloudUtil.saveWorldRank(s.CloudUtil.SAVE_WORLD_RANK_FB, e, t, r, a, o);
                }),
                (l.queryWorldRank = function (e, t, r) {
                    void 0 === r && (r = !0), s.CloudUtil.queryWorldRank(s.CloudUtil.QUERY_WORLD_RANK_FB, e, t, r);
                }),
                (l.queryTopWorldRank = function (e, t, r) {
                    void 0 === r && (r = !0), s.CloudUtil.queryTopWorldRank(s.CloudUtil.QUERY_WORLD_RANK_FB, e, t, r);
                }),
                l
            );
        })();
        ...
        var e = (function () {
            ...
            return (
                (e.saveWorldRank = function (e, t, r, a, o) {
                    void 0 === o && (o = !0), n.CloudUtil.saveWorldRank(n.CloudUtil.SAVE_WORLD_RANK_WX, e, t, r, a, o);
                }),
                (e.queryWorldRank = function (e, t, r) {
                    void 0 === r && (r = !0), n.CloudUtil.queryWorldRank(n.CloudUtil.QUERY_WORLD_RANK_WX, e, t, r);
                }),
                (e.queryTopWorldRank = function (e, t, r) {
                    void 0 === r && (r = !0),
                        n.CloudUtil.queryTopWorldRank(n.CloudUtil.QUERY_TOP_WORLD_RANK_WX, e, t, r);
                }),
                (e.checkInBlackList = function (e) {
                    n.CloudUtil.checkInBlackList(n.CloudUtil.CHALLENGE_COMPETITION_BLACK_LIST, e, !0);
                }),
                e
            );
        })();
        ...
        var e = (function () {
            ...
            return (
                (_.useTestServer = function () {
                    (_.REGISTER_WX =
                        (_.SERVER_ADDRESS_WX =
                            (_.SERVER_ADDRESS_BASE_WX = 'https://pianotiles-minigame.cmcm.com/') + 'warty/') +
                        'auth/register/wx'),
                        ...
                        (_.SHARE_HD_QUERY_WX_BATCH = _.SERVER_ADDRESS_WX + 'share/hd_query_batch'),
                        (_.SHARE_HD_REPORT_WX = _.SERVER_ADDRESS_WX + 'share/hd_report'),
                        (_.QUERY_MUSIC_PEOPLE_NUM_WX = _.SERVER_ADDRESS_WX + 'activity/query_info'),
                        ...
                        (_.RANK_QUERY_TOP_SELF_WX = _.SERVER_ADDRESS_WX + 'rank/query_top_self'),
                        (_.RANK_QUERY_SCORE_WX = _.SERVER_ADDRESS_WX + 'rank/query_score'),
                        (_.RANK_QUERY_INFO_WX = _.SERVER_ADDRESS_WX + 'rank/info'),
                        (_.RANK_QUERY_SELF_RECORD = _.SERVER_ADDRESS_WX + 'score/personal_record'),
                        (_.RANK_QUERY_OTHER_RECORD = _.SERVER_ADDRESS_WX + 'score/personal_record_query'),
                        (_.COOPERATION_QUERY_SCORE = _.SERVER_ADDRESS_WX + 'score/cooperation'),
                        (_.CHALLENGE_COMPETITION_BLACK_LIST = _.SERVER_ADDRESS_WX + 'blacklist/query'),
                        (_.INVITATION_CODE = _.SERVER_ADDRESS_WX + 'cooperation/invitation_code'),
                        (_.USER_INFO_GET_WX = _.SERVER_ADDRESS_WX + 'userinfo/get'),
                        (_.QUERY_USER_INFO_LEVEL = _.SERVER_ADDRESS_WX + 'userinfo/get_paino'),
                        (_.UPLOAD_PLAYER_FRINEDS_FB = _.SERVER_ADDRESS_WX + 'friend/report_relation');
                }),
                (_.useFBServer = function () {
                    (_.REGISTER_WX =
                        (_.SERVER_ADDRESS_WX =
                            (_.SERVER_ADDRESS_BASE_WX = 'https://pianotiles-fbgame.cmcm.com/') + 'warty/') +
                        'auth/register/wx'),
                        (_.REGISTER_H5SDK = _.SERVER_ADDRESS_WX + 'auth/register/h5sdk'),
                        (_.REGISTER_QQHALL = _.SERVER_ADDRESS_WX + 'auth/register/gamehall'),
                        (_.UPLOAD_USERR_INFO_WX = _.SERVER_ADDRESS_WX + 'auth/userinfo/wx'),
                ...
                (_.saveWorldRank = function (e, t, r, a, o, n) {
                    if ((void 0 === n && (n = !0), _.sPlayerInfo)) {
                        var i = {
                            ...
                            l = 'CMCM ' + u.hex_hmac_sha1(_.sPlayerInfo.token, JSON.stringify(i));
                ...
                (_.queryWorldRank = function (e, t, r, a) {
                    if ((void 0 === a && (a = !0), _.sPlayerInfo)) {
                        var o = {
                            ...
                            n = 'CMCM ' + u.hex_hmac_sha1(_.sPlayerInfo.token, JSON.stringify(o));
                        u.platform.networkRequest({
                            url: e,
                            data: o,
                            header: {
                            ...
                            callback: function (e, t) {
                                e && t
                                    ? r(0 == t.status, t.top_rank, t.whole_rank, t.score_value, t.score_data)
                                    : r(!1, 0, 0, 0, null);
                            },
                        });
                    } else r(!1, 0, 0, 0, null);
                ...
                (_.queryTopWorldRank = function (e, t, r, a) {
                    if ((void 0 === a && (a = !0), _.sPlayerInfo)) {
                        ...
                        u.platform.networkRequest({
                            ...
                            dataType: 'json',
                            callback: function (e, t) {
                                e && t && t.rank_list ? r(0 == t.status, t.rank_list) : r(!1, null);
                            },
                        });
                    } else r(!1, null);
                }),
                (_.reportShare = function (e, t, l, r, a, o, n) {
                    if (
                        ...
                        var i = {
                            ...
                            s = 'CMCM ' + u.hex_hmac_sha1(_.sPlayerInfo.token, JSON.stringify(i));
                        u.platform.networkRequest({
                            url: e,
                            data: i,
                            header: {
                            ...
                            callback: function (e, t) {
                                ...
                                } else l(!1, !1, 'server status error' + t.statuscode, 0, '', '');
                            },
                        });
                    } else l(!1, !1, 'not playerID', 0, '', '');
                }),
                (_.queryShare = function (e, r, t, a) {
                    if ((void 0 === t && (t = !0), void 0 === a && (a = '0600'), _.sPlayerInfo)) {
                        var o = {
                                playerid: _.sPlayerInfo.playerId,
                                timestamp: new Date().getTime(),
                                gameid: _.GAME_ID,
                    ...
                    if ((void 0 === a && (a = !0), t && 0 != t.length))
                        if (_.sPlayerInfo) {
                            ...
                            var l = {
                                ...
                                s = 'CMCM ' + u.hex_hmac_sha1(_.sPlayerInfo.token, JSON.stringify(l));
                            u.platform.networkRequest({
                                url: e,
                                data: l,
                                header: {
                ...
                (_.queryItems = function (e, r, t) {
                    if ((void 0 === t && (t = !0), _.sPlayerInfo)) {
                        var a = {
                            ...
                            o = 'CMCM ' + u.hex_hmac_sha1(_.sPlayerInfo.token, JSON.stringify(a));
                        u.platform.networkRequest({
                            url: e,
                            data: a,
                            header: {
                                ...
                                callback: function (e, t) {
                                    if (e && t) {
                                        var r = t.message,
                                            ...
                                            o = t.redpackage_id;
                                        n(0 == t.status, r, a, o);
                                    } else n(!1, 'server status error, statuscode=' + t.statuscode, '0', '');
                                },
                            });
                ...
                (_.acceptGive = function (e, t, o, r) {
                    if ((void 0 === r && (r = !0), _.sPlayerInfo)) {
                        var a = {
                            ...
                            n = 'CMCM ' + u.hex_hmac_sha1(_.sPlayerInfo.token, JSON.stringify(a));
                        u.platform.networkRequest({
                            url: e,
                            data: a,
                            header: {
                            ...
                            callback: function (e, t) {
                                ...
                                } else o(!1, 'server status error, statuscode=' + t.statuscode, '0', null);
                            },
                        });
                            ...
                            callback: function (e, t) {
                                if (e && t) {
                                    var r = t.message,
                                        a = t.timestamp;
                                    o(0 == t.status, r, a);
                                } else o(!1, 'server status error, statuscode=' + t.statuscode, '0');
                            },
                        });
                ...
                (_.reportShareHdReport = function (e, t, r, a, o, n, i) {
                    if ((void 0 === o && (o = !0), void 0 === n && (n = 5), void 0 === i && (i = 5), _.sPlayerInfo)) {
                        var l = {
                                playerid: _.sPlayerInfo.playerId,
                                gameid: _.GAME_ID,
                                timestamp: new Date().getTime(),
                ...
                (_.shareHdQuery = function (e, t, r, a) {
                    if ((void 0 === a && (a = !0), _.sPlayerInfo)) {
                        ...
                        u.platform.networkRequest({
                            ...
                            dataType: 'json',
                            callback: function (e, t) {
                                e && t && t.invitee_list ? r(0 == t.status, t.invitee_list) : r(!1, null);
                            },
                        });
                    } else r(!1, null);
                }),
                (_.shareHdQueryBatch = function (r, a, o, n) {
                    if ((void 0 === n && (n = !0), _.sPlayerInfo)) {
                        var e = {
                            ...
                            t = 'CMCM ' + u.hex_hmac_sha1(_.sPlayerInfo.token, JSON.stringify(e));
                        u.platform.networkRequest({
                            url: r,
                            data: e,
                            header: {
                            ...
                            callback: function (e, t) {
                                e && t && t.hd_invitee_map
                                    ...
                                    : n && t && (403 == t.statuscode || 1001 == t.status)
                                    ? (_.sPlayerInfo &&
                                          ((_.sPlayerInfo.playerId = void 0), (_.sPlayerInfo.token = void 0)),
                ...
                (_.queryMusicPeopleNums = function (e, t, r, a) {
                    if ((void 0 === a && (a = !0), _.sPlayerInfo)) {
                        ...
                        var n = {
                            ...
                            i = 'CMCM ' + u.hex_hmac_sha1(_.sPlayerInfo.token, JSON.stringify(n));
                        u.platform.networkRequest({
                            url: e,
                            data: n,
                            header: {
                ...
                (_.checkInBlackList = function (e, r, t) {
                    if (_.sPlayerInfo) {
                        ...
                        u.platform.networkRequest({
                            ...
                            dataType: 'json',
                            callback: function (e, t) {
                                e && t && t.data ? r(0 == t.status, t.data.is_black) : r(!1, null);
                            },
                        });
                    } else r(!1, !1);
                }),
                ...
                (_.REGISTER_WX = (_.SERVER_ADDRESS_WX = _.SERVER_ADDRESS_BASE_WX + 'warty/') + 'auth/register/wx'),
                (_.REGISTER_H5SDK = _.SERVER_ADDRESS_WX + 'auth/register/h5sdk'),
                (_.REGISTER_QQHALL = _.SERVER_ADDRESS_WX + 'auth/register/gamehall'),
                (_.UPLOAD_USERR_INFO_WX = _.SERVER_ADDRESS_WX + 'auth/userinfo/wx'),
                (_.SET_STORAGE_WX = _.SERVER_ADDRESS_WX + 'storage/set'),
                ...
                (_.REPACKAGE_CANCEL_WX = _.SERVER_ADDRESS_WX + 'item/redpackage_cancel'),
                ...
                (_.REGISTER_FB = (_.SERVER_ADDRESS_FB = 'https://instantgame.cmcm.com/warty/') + 'auth/register/fb'),
                ...
                (_.SAVE_WORLD_RANK_FB =
                    (_.SERVER_ADDRESS_WORLD_RANK_FB = 'http://10.12.32.113:80/warty/') + 'rank/save'),
                (_.QUERY_WORLD_RANK_FB = _.SERVER_ADDRESS_WORLD_RANK_FB + 'rank/query'),
                (_.QUERY_TOP_WORLD_RANK_FB = _.SERVER_ADDRESS_WORLD_RANK_FB + 'rank/query_top'),
                (_.METHOD_GET = 'GET'),
                (_.METHOD_HEAD = 'HEAD'),
                (_.METHOD_POST = 'POST'),
                (_.METHOD_PUT = 'PUT'),
                ...
                (e.getFriendsPlayerInfo = function (t) {
                    if (t) {
                        ...
                        FBInstant.player
                            ...
                            .then(function (e) {
                                r.Platform.log('FBHelper: getConnectedPlayersAsync then ' + e), t(e);
                            })
                            .catch(function (e) {
                                r.Platform.log('FBHelper: getConnectedPlayersAsync error: ' + e),
    ...
    (function (e) {
            ...
            return (
                                ...
                                (((o =
                                    ((((o +=
                                        (((n =
                                            ((((n +=
                                                (((r =
                                                    ((((r += ((a ^ o ^ n) + t[9] - 640364487) | 0) << 4) | (r >>> 28)) +
                                                        a) |
                                                    0) ^
                                                    a ^
                                                    o) +
                            ...
                            ((((a +=
                                (((n =
                                    ((((n +=
                                        ((a ^
                                            ((r =
                                                ((((r += ((o ^ (a | ~n)) + t[0] - 198630844) | 0) << 6) | (r >>> 26)) +
                                                    a) |
                                                0) |
                                                ~o)) +
                                            t[7] +
                                    ...
                                    0) ^
                                    ((o =
                                        ((((o += ((r ^ (n | ~a)) + t[14] - 1416354905) | 0) << 15) | (o >>> 17)) + n) |
                                        0) |
                                        ~r)) +
                                    t[5] -
                                    57434055) |
                        ...
                        (a =
                            ((((a +=
                                (((n =
                                    ...
                                    0) ^
                                    ((o =
                                        ((((o += ((r ^ (n | ~a)) + t[10] - 1051523) | 0) << 15) | (o >>> 17)) + n) |
                                        0) |
                                        ~r)) +
                                    t[1] -
                                    2054922799) |
                            ...
                            ((((a +=
                                (((n =
                                    ((((n +=
                                        ((a ^
                                            ((r =
                                                ((((r += ((o ^ (a | ~n)) + t[8] + 1873313359) | 0) << 6) | (r >>> 26)) +
                                                    a) |
                                                0) |
                                                ~o)) +
                                            t[15] -
                                    ...
                                    0) ^
                                    ((o =
                                        ((((o += ((r ^ (n | ~a)) + t[6] - 1560198380) | 0) << 15) | (o >>> 17)) + n) |
                                        0) |
                                        ~r)) +
                                    t[13] +
                                    1309151649) |
                            ...
                            ((((a +=
                                (((n =
                                    ((((n +=
                                        ((a ^
                                            ((r =
                                                ((((r += ((o ^ (a | ~n)) + t[4] - 145523070) | 0) << 6) | (r >>> 26)) +
                                                    a) |
                                                0) |
                                                ~o)) +
                                            t[11] -
                                    ...
                                    0) ^
                                    ((o =
                                        ((((o += ((r ^ (n | ~a)) + t[2] + 718787259) | 0) << 15) | (o >>> 17)) + n) |
                                        0) |
                                        ~r)) +
                                    t[9] -
                                    343485551) |
                ...
                (_.prototype.appendStr = function (e) {
                    ...
                    for (r = 0; r < e.length; r += 1) {
                        ...
                        else if (t < 2048) (a[n++] = 192 + (t >>> 6)), (a[n++] = (63 & t) | 128);
                        else if (t < 55296 || 56319 < t)
                            (a[n++] = 224 + (t >>> 12)), (a[n++] = ((t >>> 6) & 63) | 128), (a[n++] = (63 & t) | 128);
                        else {
                            if (1114111 < (t = 1024 * (t - 55296) + (e.charCodeAt(++r) - 56320) + 65536))
                        ...
                        64 <= n && ((this._dataLength += 64), _._md5cycle(this._state, o), (n -= 64), (o[0] = o[16]));
                    }
                    return (this._bufferLength = n), this;
                }),
                (_.prototype.appendAsciiStr = function (e) {
                    for (var t, r = this._buffer8, a = this._buffer32, o = this._bufferLength, n = 0; ; ) {
                        for (t = Math.min(e.length - n, 64 - o); t--; ) r[o++] = e.charCodeAt(n++);
                        if (o < 64) break;
                ...
                (_.prototype.end = function (e) {
                    ...
                    return _._md5cycle(this._state, o), e ? this._state : _._hex(this._state);
                }),
        ...
        '5d41402abc4b2a76b9719d911017c592' !== (e.Md5 = t).hashStr('hello') && console.error('Md5 self test failed.');
    })(cmg || (cmg = {})),
    (function (s) {
        var e = (function () {
            function l() {
            ...
            return (
                ...
                (l.log = function (e) {
                    ...
                    l.isPrintLog &&
                        (cc.sys.platform === cc.sys.QQ_PLAY
                            ? BK.Script.log(1, 1, '[qqplay_release_log]  msg: ' + e + ' subst: ' + this.toJsonString(t))
                            : console.log(e, t));
                }),
                (l.warn = function (e) {
                    for (var t = [], r = 1; r < arguments.length; r++) t[r - 1] = arguments[r];
                ...
                (l.prototype.exitGame = function (e) {
                    l.log('Platform::exitGame'), this.mAdapter && this.mAdapter.exitGame(e);
                }),
                ...
                (l.prototype.reportScore = function (e, t, r, a, o) {
                    void 0 === o && (o = !1), this.mAdapter ? this.mAdapter.reportScore(e, t, r, a, o) : a && a(!1);
                }),
                (l.prototype.queryFriendsScore = function (e, t, r) {
                    void 0 === r && (r = !1),
                        this.mAdapter ? this.mAdapter.queryFriendsScore(e, t, r) : t && t(!1, e, null);
                }),
                (l.prototype.saveWorldRank = function (e, t, r, a, o) {
                    void 0 === o && (o = !1), this.mAdapter ? this.mAdapter.saveWorldRank(e, t, r, a, o) : a && a(!1);
                }),
                (l.prototype.queryWorldRank = function (e, t, r) {
                    void 0 === r && (r = !1),
                        this.mAdapter ? this.mAdapter.queryWorldRank(e, t, r) : t && t(!1, 0, 0, 0, null);
                }),
                (l.prototype.queryTopWorldRank = function (e, t, r) {
                    void 0 === r && (r = !1),
                        this.mAdapter ? this.mAdapter.queryTopWorldRank(e, t, r) : t && t(!1, null);
                }),
                (l.prototype.getRankName = function (e, t) {
                    if (t) {
                        ...
                        4 == a.length && (a = a.substr(2, 2)), (e = 'weekly_' + e + '_' + a + '_' + o.toString());
                    } else e = 'ever_' + e;
                ...
                (l.prototype.queryShareCompetition = function (e, t) {
                    void 0 === t && (t = '2200'),
                        this.mAdapter ? this.mAdapter.queryShareCompetition(e, t) : e && e(!1, '', null);
                }),
                ...
                (l.prototype.queryShareSkin = function (e) {
                    this.mAdapter ? this.mAdapter.queryShareSkin(e) : e && e(!1, '', null);
                }),
                ...
                (l.prototype.shareQueryBatch = function (e, t) {
                    this.mAdapter ? this.mAdapter.shareQueryBatch(e, t) : t && t(!1, null);
                }),
                (l.prototype.queryMusicPeopleNums = function (e, t) {
                    this.mAdapter ? this.mAdapter.queryMusicPeopleNums(e, t) : t && t(!1, null);
                }),
                ...
                (l.prototype.pushCommonMessage = function (e, t, r, a) {
                    return this.mAdapter ? this.mAdapter.pushCommonMessage(e, t, r, a) : (a && a(!1, null), null);
                }),
    ...
    (function (e) {
        ...
        function o(e) {
            for (var t, r = n ? '0123456789ABCDEF' : '0123456789abcdef', a = '', o = 0; o < e.length; o++)
                (t = e.charCodeAt(o)), (a += r.charAt((t >>> 4) & 15) + r.charAt(15 & t));
            return a;
        }
        ...
        function s(e, t) {
            ...
            for (r = 0; r < s.length; r++) s[r] = (e.charCodeAt(2 * r) << 8) | e.charCodeAt(2 * r + 1);
            for (; 0 < s.length; ) {
        ...
        function u(e) {
            ...
            for (r = 0; r < 8 * e.length; r += 8) t[r >> 5] |= (255 & e.charCodeAt(r / 8)) << (24 - (r % 32));
            return t;
        }
        ...
        function d(e, t) {
            ...
            for (
                ...
                for (var u = o, c = n, d = i, p = l, E = s, R = 0; R < 80; R++) {
                    a[R] = R < 16 ? e[_ + R] : y(a[R - 3] ^ a[R - 8] ^ a[R - 14] ^ a[R - 16], 1);
                    var f = h(
                        h(y(o, 5), S(R, n, i, l)),
                        h(
                            h(s, a[R]),
                            (r = R) < 20 ? 1518500249 : r < 40 ? 1859775393 : r < 60 ? -1894007588 : -899497514,
                        ),
                    );
                    (s = l), (l = i), (i = y(n, 30)), (n = o), (o = f);
                }
                (o = h(o, u)), (n = h(n, c)), (i = h(i, d)), (l = h(l, p)), (s = h(s, E));
            }
            return Array(o, n, i, l, s);
        }

        function S(e, t, r, a) {
            return e < 20 ? (t & r) | (~t & a) : e < 40 ? t ^ r ^ a : e < 60 ? (t & r) | (t & a) | (r & a) : t ^ r ^ a;
        }
        ...
        var t = (function () {
            ...
            return (
                (e.compareVersion = function (e, t) {
                    for (var r = e.split('.'), a = t.split('.'), o = Math.max(r.length, a.length), n = 0; n < o; n++) {
    ...
    (function (r) {
        var e = (function () {
            ...
            return (
                                ...
                                r.Platform.log('WXHelper networkRequest, complete:', e),
                                    t.callback &&
                                        (200 != e.statusCode
                                            ...
                                            : (r.Platform.error(e), t.callback(!1, e, e.statusCode, e.header)));
                            },
                            fail: function () {
                ...
                (e.KEY_USER_INFO_AUTHORIZATION_STATE = 'key_user_info_authorization_state'),
                e
            );
        })();
        r.WXHelper = e;
