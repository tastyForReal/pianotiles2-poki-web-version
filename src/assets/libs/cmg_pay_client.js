...
(function (l) {
    ...
    var e = (function () {
        ...
        return (
            (e.prototype.init = function (e, t, r, a, n, o) {
                void 0 === o && (o = !1),
                    o && ((t = l.Platform.PLATFORM_WECHAT_TEST), (l.Platform.isPrintLog = !0)),
            ...
            (e.prototype.consume = function (e, t, r, a) {
                null != this.mDataManager ? this.mDataManager.consume(e, t, r, a) : a(n.NOT_INIT, null);
            }),
            (e.prototype.present = function (e, t, r, a) {
                null != this.mDataManager ? this.mDataManager.present(e, t, r, a) : a(n.NOT_INIT, null);
            }),
            (e.prototype.getBalance = function (e) {
                null != this.mDataManager ? this.mDataManager.getBalance(e) : e(n.NOT_INIT, null);
            }),
            ...
            (e.prototype.getHistroyTrade = function (e, t, r) {
                null != this.mDataManager ? this.mDataManager.getHistroyTrade(e, t, r) : r(n.NOT_INIT, null);
            }),
            (e.prototype.buyHonor = function (e, t) {
                null != this.mDataManager ? this.mDataManager.buyHonor(e, t) : t(n.NOT_INIT, null);
            }),
            (e.prototype.destroy = function (e) {
                l.Platform.log('Client::destroy'), this.mDataManager && this.mDataManager.destroy(e);
            }),
            e
        );
    })();
    ...
    (function (o) {
        var l = (function () {
            function e() {}
            return (e.PERPAY = 'request_perpay'), (e.PAY = 'request_pay'), (e.CHECK_PAY = 'request_check_pay'), e;
        })();
        o.RechargeStage = l;
        var e = (function () {
            function n() {}
            return (
                (n.prototype.isUserCancel = function () {
                    return null != this.midasErrCode && (-2 == this.midasErrCode || 1 == this.midasErrCode);
                }),
            ...
            return (
                ...
                (e.prototype.recharge = function (n, o) {
                    ...
                    this.mNetRequester.perpay(e, n, function (e, t, r, a) {
                        e == i.ClientPayCode.SUCESS
                            ? (i.Platform.log('perpay: localBillNo ' + t + ', serverBillNo: ' + r + ', balance: ' + a),
                              o(i.RechargeResponse.create(i.RechargeStage.PERPAY, i.ClientPayCode.SUCESS)),
                              l.requestMidasPayment(n, a, o))
                            : o(i.RechargeResponse.create(i.RechargeStage.PERPAY, i.ClientPayCode.SERVER_ERROR_PERPAY));
                    });
                }),
                        ...
                        n = {
                            ...
                            fail: function (e) {
                                ...
                                i.Platform.log('requestMidasPayment fail'),
                                    console.error(t, r),
                                    a(i.RechargeResponse.createMidas(i.ClientPayCode.MIDAS_ERROR, t, r));
                            },
                            complete: function () {
                ...
                (e.prototype.checkBalance = function (r, a) {
                    this.mNetRequester.getBalance(function (e, t) {
                        e == i.ClientPayCode.SUCESS
                            ? (i.Platform.log(
                                  'checkBalance success preBlance: ' + r + ', current blance: ' + t.balance,
                              ),
                              (t.preBalance = r),
                              t.balance <= r
                                  ? a(
                                  ...
                                  : a(i.RechargeResponse.create(i.RechargeStage.CHECK_PAY, i.ClientPayCode.SUCESS, t)))
                            : a(
                                  i.RechargeResponse.create(
                                      i.RechargeStage.CHECK_PAY,
        ...
        var e = (function () {
            function e(e) {
                (this.urlPerpay = 'payment/midas/prepay'),
                    ...
                    (this.urlGetBalance = this.mPlatform.getBaseServerUrl() + this.urlGetBalance),
                    (this.urlPretrade = this.mPlatform.getBaseServerUrl() + this.urlPretrade),
                    (this.urlPay = this.mPlatform.getBaseServerUrl() + this.urlPay),
                    (this.urlGetHistoryTrade = this.mPlatform.getBaseServerUrl() + this.urlGetHistoryTrade),
                    (this.urlPresent = this.mPlatform.getBaseServerUrl() + this.urlPresent),
                    (this.urlBuyHonor = this.mPlatform.getBaseServerUrl() + this.urlBuyHonor);
            }
            return (
                (e.prototype.perpay = function (a, e, n) {
                    ...
                    this.mPlatform.netwrokRequest(this.urlPerpay, t, function (e, t) {
                        s.Platform.log('PayNetRequester#perpay#result: ' + e), s.Platform.log(t);
                        var r = e ? s.ClientPayCode.SUCESS : s.ClientPayCode.SERVER_NET_ERROR;
                ...
                (e.prototype.getBalance = function (n) {
                    this.mPlatform.netwrokRequest(this.urlGetBalance, {}, function (e, t) {
                        s.Platform.log('PayNetRequester#getBalance#result: ' + e), s.Platform.log(t);
                        var r = e ? s.ClientPayCode.SUCESS : s.ClientPayCode.SERVER_NET_ERROR;
                        if (e && null != t) {
                ...
                (e.prototype.pretrade = function (a) {
                    this.mPlatform.netwrokRequest(this.urlPretrade, {}, function (e, t) {
                        s.Platform.log('PayNetRequester#pretrade#result: ' + e), s.Platform.log(t);
                        var r = e ? s.ClientPayCode.SUCESS : s.ClientPayCode.SERVER_NET_ERROR;
                ...
                (e.prototype.pay = function (e, t, r, a, n) {
                    ...
                    this.mPlatform.netwrokRequest(this.urlPay, o, function (e, t) {
                        s.Platform.log('PayNetRequester#pay#result: ' + e), s.Platform.log(t);
                        var r = e ? s.ClientPayCode.SUCESS : s.ClientPayCode.SERVER_NET_ERROR;
                ...
                (e.prototype.present = function (e, t, r, a, n) {
                    ...
                    this.mPlatform.netwrokRequest(this.urlPresent, o, function (e, t) {
                        s.Platform.log('PayNetRequester#present#result: ' + e), s.Platform.log(t);
                        var r = e ? s.ClientPayCode.SUCESS : s.ClientPayCode.SERVER_NET_ERROR;
                        e && null != t && null != t.balance
                            ? n(r, t.balance)
                            : n(s.ClientPayCode.SERVER_NET_ERROR, null);
                ...
                (e.prototype.getHistroyTrade = function (e, t, a) {
                    ...
                    this.mPlatform.netwrokRequest(this.urlGetHistoryTrade, r, function (e, t) {
                        s.Platform.log('PayNetRequester#getHistroyTrade#result: ' + e), s.Platform.log(t);
                        var r = e ? s.ClientPayCode.SUCESS : s.ClientPayCode.SERVER_NET_ERROR;
                        e && null != t ? a(r, 0) : a(s.ClientPayCode.SERVER_NET_ERROR, null);
                    });
                }),
                (e.prototype.buyHonor = function (i, u) {
                    ...
                    this.mPlatform.netwrokRequest(this.urlBuyHonor, e, function (e, t) {
                        if (
                            (s.Platform.log('PayNetRequester#buyHonor#result: ' + e), s.Platform.log(t), t && t.status)
                        ) {
                            var r = null;
                            if (t.infos)
                                try {
                            ...
                            if (!r)
                                return (
                                    s.Platform.log('PayNetRequester#buyHonor#dataInfo parse error'),
                            ...
                            if (l == s.ClientPayCode.SUCESS)
                                (null == (o = a.get(i)) || null == o || o <= 0) &&
                                    (s.Platform.log('PayNetRequester#buyHonor#cannot find itemId'),
        ...
        var t = (function () {
                function e() {
                    ...
                    this.SERVER_ADDRESS_BASE =
                        'oversea' == e ? 'https://h5game_oversea.cmcm.com/warty/' : 'https://minigame.cmcm.com/warty/';
                }
                return (
                    ...
                    (s.prototype.netwrokRequest = function (r, a, n, o) {
                        ...
                        this.doNetworkRequest({
                            ...
                            callback: function (e, t) {
                                (o -= 1), 0 == e && 0 < o ? l.netwrokRequest(r, a, n, o) : n(e, t);
                            },
                        });
                    }),
                    ...
                    (s.prototype.doNetworkRequest = function (i) {
                        ...
                        this.mPlatformProxy.networkRequest({
                            ...
                            callback: function (e, t, r, a) {
                                var n = null;
                                if (e) {
                                    (n = JSON.parse(t)), u.refleshLocalTimeDiff(1e3 * n.timestamp);
                                    ...
                                    if (!l)
                                        return (
                                            s.error('networkRequest, Local token is empty'), void i.callback(!1, null)
                                        );
    ...
    (function (e) {
        ...
        function n(e) {
            for (var t, r = o ? '0123456789ABCDEF' : '0123456789abcdef', a = '', n = 0; n < e.length; n++)
                (t = e.charCodeAt(n)), (a += r.charAt((t >>> 4) & 15) + r.charAt(15 & t));
            return a;
        }
        ...
        function u(e, t) {
            ...
            for (r = 0; r < u.length; r++) u[r] = (e.charCodeAt(2 * r) << 8) | e.charCodeAt(2 * r + 1);
            for (; 0 < u.length; ) {
        ...
        function R(e, t) {
            ...
            for (
                ...
                for (var c = n, f = o, R = l, m = i, y = u, h = 0; h < 80; h++) {
                    a[h] = h < 16 ? e[s + h] : d(a[h - 3] ^ a[h - 8] ^ a[h - 14] ^ a[h - 16], 1);
                    var P = p(
                        p(d(n, 5), g(h, o, l, i)),
                        p(
                            p(u, a[h]),
                            (r = h) < 20 ? 1518500249 : r < 40 ? 1859775393 : r < 60 ? -1894007588 : -899497514,
                        ),
                    );
                    (u = i), (i = l), (l = d(o, 30)), (o = n), (n = P);
                }
                (n = p(n, c)), (o = p(o, f)), (l = p(l, R)), (i = p(i, m)), (u = p(u, y));
            }
                        ...
                        wx.request({
                            ...
                            success: function (e) {
                                r.Platform.log('WXHelper networkRequest, complete:'),
                                    ...
                                    t.callback &&
                                        (200 != e.statusCode
                                            ? (r.Platform.error('WXHelper networkRequest, fail: Code:' + e.statusCode),
