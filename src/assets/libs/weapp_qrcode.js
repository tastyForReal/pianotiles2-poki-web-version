            ...
            return (
                ...
                (s.prototype.make = function () {
                    if (this.typeNumber < 1) {
                        ...
                        for (t = 1; t < 40; t++) {
                            for (
                                var e = h.getRSBlocks(t, this.errorCorrectLevel), r = new l(), o = 0, n = 0;
                                n < e.length;
                                n++
                            )
                                o += e[n].dataCount;
                ...
                (s.prototype.setupTypeInfo = function (t, e) {
                    for (var r = (this.errorCorrectLevel << 3) | e, o = C.getBCHTypeInfo(r), n = 0; n < 15; n++) {
                        var i = !t && 1 == ((o >> n) & 1);
                        n < 6
                            ? (this.modules[n][8] = i)
                            : n < 8
                ...
                (s.prototype.mapData = function (t, e) {
                    for (var r = -1, o = this.moduleCount - 1, n = 7, i = 0, u = this.moduleCount - 1; 0 < u; u -= 2)
                        for (6 == u && u--; ; ) {
                            for (var a = 0; a < 2; a++)
                ...
                (s.createData = function (t, e, r) {
                    for (var o = h.getRSBlocks(t, e), n = new l(), i = 0; i < r.length; i++) {
                        var u = r[i];
                        n.put(u.mode, 4), n.put(u.getLength(), C.getLengthInBits(u.mode, t)), u.write(n);
                    }
                    var a = 0;
                    for (i = 0; i < o.length; i++) a += o[i].dataCount;
                    if (n.getLengthInBits() > 8 * a)
                        throw new Error('code length overflow. (' + n.getLengthInBits() + '>' + 8 * a + ')');
                    for (n.getLengthInBits() + 4 <= 8 * a && n.put(0, 4); n.getLengthInBits() % 8 != 0; ) n.putBit(!1);
                    for (; !(n.getLengthInBits() >= 8 * a || (n.put(s.PAD0, 8), n.getLengthInBits() >= 8 * a)); )
                        n.put(s.PAD1, 8);
                    return s.createBytes(n, o);
                }),
                (s.createBytes = function (t, e) {
                    for (
                        var r = 0, o = 0, n = 0, i = new Array(e.length), u = new Array(e.length), a = 0;
                        a < e.length;
                        a++
                    ) {
                        var s = e[a].dataCount,
                    ...
                    var p = new Array(d),
                        m = 0;
                    for (f = 0; f < o; f++) for (a = 0; a < e.length; a++) f < i[a].length && (p[m++] = i[a][f]);
                    for (f = 0; f < n; f++) for (a = 0; a < e.length; a++) f < u[a].length && (p[m++] = u[a][f]);
                    return p;
                }),
                (s.PAD0 = 236),
                (s.PAD1 = 17),
    ...
    var C = (function () {
            ...
            return (
                ...
                (r.getErrorCorrectPolynomial = function (t) {
                    for (var e = new v([1], 0), r = 0; r < t; r++) e = e.multiply(new v([1, i.gexp(r)], 0));
                    return e;
                }),
            ...
            return (
                ...
                (e.initTable = function () {
                    if (!e.inited) {
                        ...
                        for (t = 8; t < 256; t++)
                            e.EXP_TABLE[t] =
                                e.EXP_TABLE[t - 4] ^ e.EXP_TABLE[t - 5] ^ e.EXP_TABLE[t - 6] ^ e.EXP_TABLE[t - 8];
        ...
        v = (function () {
            ...
            return (
                ...
                (n.prototype.mod = function (t) {
                    ...
                    for (
                        var e = i.glog(this.get(0)) - i.glog(t.get(0)), r = new Array(this.getLength()), o = 0;
                        o < this.getLength();
                        o++
                    )
                        r[o] = this.get(o);
                    for (o = 0; o < t.getLength(); o++) r[o] ^= i.gexp(i.glog(t.get(o)) + e);
            ...
            return (
                (f.getRSBlocks = function (t, e) {
                    ...
                    for (var o = r.length / 3, n = new Array(), i = 0; i < o; i++)
                        for (var u = r[3 * i + 0], a = r[3 * i + 1], s = r[3 * i + 2], h = 0; h < u; h++)
                            n.push(new f(a, s));
                    return n;
                }),
        ...
        (t.drawQRCode = function (t) {
            if (t && t.ctx) {
                ...
                e.addData(
                    ...
                    e.make();
                for (
                    var r = t.ctx, o = t.width / e.getModuleCount(), n = t.height / e.getModuleCount(), i = 0;
                    i < e.getModuleCount();
                    i++
                )
