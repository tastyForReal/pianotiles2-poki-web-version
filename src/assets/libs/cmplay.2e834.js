...
!(function (a) {
    ...
    var e = (function () {
        function t() {}
        return (t.LOADING_BEGIN = 'loading_begin'), (t.LOADING_END = 'loading_end'), t;
    })();
    a.STATE = e;
    var r = (function () {
        function t() {}
    ...
    function l() {
        ...
        var t = function () {
                try {
                    if (window.GameJs && window.GameJs.getDisplayWidth) return window.GameJs.getDisplayWidth();
                } catch (t) {
            ...
            e = function () {
                try {
                    if (window.GameJs && window.GameJs.getDisplayHeight) return window.GameJs.getDisplayHeight();
                } catch (t) {
        ...
        return (
            (a.Global.data.mSystemInfo = {
                ...
                packageName: (function () {
                    try {
                        if (window.GameJs && window.GameJs.getAppPackageName) return window.GameJs.getAppPackageName();
                    } catch (t) {
                ...
                packageVersion: (function () {
                    try {
                        if (window.GameJs && window.GameJs.getAppVersion) return window.GameJs.getAppVersion();
                    } catch (t) {
                ...
                isTestMode: (function () {
                    try {
                        if (window.GameJs && window.GameJs.isTestMode) return window.GameJs.isTestMode();
                    } catch (t) {
                        a.Log.error('CMPlay::isTestMode ERROR => ' + t.message), a.Log.error(JSON.stringify(t.stack));
                    }
                    return !1;
                })(),
                channelId: (function () {
                    try {
                        if (window.GameJs && window.GameJs.getChannelId) return window.GameJs.getChannelId();
                    } catch (t) {
    ...
    (a.init = function (t) {
        ...
        if (t.gameId <= 6e3 || 99999 < t.gameId) throw new Error('init => ERROR: Invalid gameId ' + t.gameId);
        if (!t.gameName || t.gameName.length < 1) throw new Error('init => ERROR: Invalid gameName ' + t.gameName);
        a.Log.log('init => pageId:' + t.pageId + ' gameId:' + t.gameId + ' gameName:' + t.gameName);
        var e = 'oversea';
        if (
        ...
        try {
            ...
            a.Log.error('CMPlay::init ERROR => ' + t.message), a.Log.error(JSON.stringify(t.stack));
        }
        (s = new a.AudioImpl()),
            (i = n = !1),
        ...
        (window.onAdShowFailed = function () {
            try {
                null != a.Global.data.mRewardVideoCallback &&
                    (a.Global.data.mRewardVideoCallback(!1), (a.Global.data.mRewardVideoCallback = void 0));
            } catch (t) {
                a.Log.error('CMPlay::onAdShowSuccess ERROR => ' + t.message), a.Log.error(JSON.stringify(t.stack));
            }
        }),
        (window.onAdShowSuccess = function () {
            try {
                null != a.Global.data.mRewardVideoCallback &&
                    (a.Global.data.mRewardVideoCallback(!0), (a.Global.data.mRewardVideoCallback = void 0));
            } catch (t) {
                a.Log.error('CMPlay::onAdShowSuccess ERROR => ' + t.message), a.Log.error(JSON.stringify(t.stack));
            }
        }),
        (window.onShareSuccess = function () {
            try {
                ...
                a.Log.error('CMPlay::onShareSuccess ERROR => ' + t.message), a.Log.error(JSON.stringify(t.stack));
            }
        }),
        ...
        (window.onActivityShow = function () {
            ...
            for (var t = 0; t < a.Global.data.mOnShowCBList.length; t++)
                try {
                    ...
                    a.Log.error('CMPlay::onActivityShow ERROR => ' + t.message), a.Log.error(JSON.stringify(t.stack));
                }
            (n = !1), i || s.resumeBGM();
        }),
        (window.onActivityHide = function () {
            ...
            for (var t = 0; t < a.Global.data.mOnHideCBList.length; t++)
                try {
                    ...
                    a.Log.error('CMPlay::onActivityHide ERROR => ' + t.message), a.Log.error(JSON.stringify(t.stack));
                }
            (n = !0), i || s.pauseBGM();
        }),
        (window.adShowCallback = function (t) {
            try {
                ...
                if (
                    ...
                    else if ('bqr' == e.unitId && (d.mShareItAd.loadRewardAd(), !e.hasRewarded)) return;
                    null != a.Global.data.mRewardVideoCallback &&
                        (a.Global.data.mRewardVideoCallback(!0), (a.Global.data.mRewardVideoCallback = void 0));
                }
            } catch (t) {
                a.Log.error('adShowCallback ERROR => ' + t.message), a.Log.error(JSON.stringify(t.stack));
            }
        }),
        (window.adLoadCallback = function (t) {
            try {
                var e = JSON.parse(t);
                a.Log.log('adLoadCallback => result_message::' + e.result_message + 'responseCode = ' + e.responseCode);
            } catch (t) {
                a.Log.error('adLoadCallback ERROR => ' + t.message), a.Log.error(JSON.stringify(t.stack));
            }
        }),
        ...
        (a.hasTTAd = function () {
            return window.RewardVideo && window.RewardVideo.hasTTAd && window.RewardVideo.hasTTAd();
        }),
        ...
        (a.shareDialog = function (t) {
            if (window.GameJs && window.GameJs.onShareDialog) {
                try {
                    ...
                    a.Log.error('CMPlay::shareDialog ERROR => ' + t.message), a.Log.error(JSON.stringify(t.stack));
                }
                return !1;
            }
        }),
        (a.startRewardVideo = function (e) {
            try {
                o.startRewardVideo(function (t) {
                    c.reportAction(t ? r.REWARDED_VIDEO_SUCCESS : r.REWARDED_VIDEO_FAILED), e && e(t);
        ...
        (a.showInterstitialAd = function (t) {
            try {
                ...
                a.Log.error('CMPlay::showInterstitialAd ERROR =>' + t.message), a.Log.error(JSON.stringify(t.stack));
            }
        }),
        ...
        (a.showBanner = function () {
            try {
                ...
                a.Log.error('CMPlay::showBanner ERROR => ' + t.message), a.Log.error(JSON.stringify(t.stack));
            }
        }),
        (a.hideBanner = function () {
            try {
                ...
                a.Log.error('CMPlay::hideBanner ERROR => ' + t.message), a.Log.error(JSON.stringify(t.stack));
            }
        }),
        (a.showToast = function (t, e) {
            try {
                window.GameJs && window.GameJs.showToast && window.GameJs.showToast(t, e);
            } catch (t) {
                a.Log.error('CMPlay::showToast ERROR => ' + t.message), a.Log.error(JSON.stringify(t.stack));
            }
        }),
        (a.onShow = function (t) {
        ...
        (a.offShow = function (t) {
            for (var e = 0; e < a.Global.data.mOnShowCBList.length; e++)
                a.Global.data.mOnShowCBList[e] == t && delete a.Global.data.mOnShowCBList[e];
        }),
        (a.onHide = function (t) {
        ...
        (a.offHide = function (t) {
            for (var e = 0; e < a.Global.data.mOnHideCBList.length; e++)
                a.Global.data.mOnHideCBList[e] == t && delete a.Global.data.mOnHideCBList[e];
        }),
        (a.getStorageSync = function (t, e) {
            try {
                if (window.GameJs && window.GameJs.getLocalStringValue) return window.GameJs.getLocalStringValue(t, e);
            } catch (t) {
                a.Log.error('CMPlay::getStorageSync ERROR => ' + t.message), a.Log.error(JSON.stringify(t.stack));
            }
        }),
        (a.setStorageSync = function (t, e) {
            try {
                if (window.GameJs && window.GameJs.setLocalStringValue) return window.GameJs.setLocalStringValue(t, e);
            } catch (t) {
                a.Log.error('CMPlay::setStorageSync ERROR => ' + t.message), a.Log.error(JSON.stringify(t.stack));
            }
        }),
    ...
    var c = (function () {
        ...
        return (
            (n.report = function (t, e) {
                try {
                    window.RewardVideo && window.RewardVideo.reportData && window.RewardVideo.reportData(t, e);
                } catch (t) {
                    a.Log.error('CMPlay::report ERROR => ' + t.message), a.Log.error(JSON.stringify(t.stack));
                }
            }),
            (n.reportAction = function (t) {
                if (
                    ...
                    if (0 <= n.UNIQE_EVENT_LIST.indexOf(t))
                        return void a.Log.log('reportAction => skip action[' + t + '] for duplicate');
                    n.UNIQE_EVENT_LIST.unshift(t);
                }
                if ((a.Log.log('reportAction => ' + t), window.RewardVideo && window.RewardVideo.reportData)) {
                    var e =
                        'page=' + a.Global.public.game_page + '&game_ver=' + a.Global.public.game_ver + '&action=' + t;
            ...
            (n.reportErrMsg = function (t, e, o) {
                window.RewardVideo && window.RewardVideo.reportData
                    ? n.report('gamemaster_business_h5game_errmsg', 'url=' + t + '&errcode=' + e + '&errmsg=' + o)
    ...
    (a.Infoc = c),
        (a.login = function (i) {
            try {
                o.login(function (t, e, o, n, a) {
                    c.reportAction(t ? r.LOGIN_SUCCESS : r.LOGIN_FAILED), i && i(t, e, o, n, a);
                });
            } catch (t) {
        ...
        (a.setState = function (t) {
            if ((a.Log.log('setState => ' + t), window.GameJs && window.GameJs.setState))
                try {
                    window.GameJs.setState(t);
                } catch (t) {
                    a.Log.error('CMPlay::setState ERROR => ' + t.message), a.Log.error(JSON.stringify(t.stack));
                }
        });
    var t = (function () {
        function t() {}
        return (
            ...
            (t.onGameLoadFinished = function () {
                a.Log.warn('===> onGameLoadFinished'), a.setState(e.LOADING_END), o && o.onGameLoadFinished();
            }),
            (t.onGameMainStart = function () {
                a.Log.warn('===> onGameMainStart'), a.Infoc.reportAction(r.MAIN_PAGE), o && o.onGameMainStart();
            }),
    ...
    var p = (function () {
        ...
        return (
            (t.playBGM = function (t, e, o) {
                if ((void 0 === e && (e = !0), void 0 === o && (o = 1), i)) a.Log.warn('===> playBGM[mute]: ' + t);
                else {
            ...
            (t.playEffect = function (t, e) {
                if ((void 0 === e && (e = 1), i)) a.Log.warn('===> playEffect[mute]: ' + t);
                else {
                    if (!n) return a.Log.warn('===> playEffect: ' + t), s.playEffect(t, e);
    ...
    (function (t) {
        ...
        (t.showBanner = function () {
            null == e && ((e = setTimeout(this._refreshBanner, 3e4)), CMPlay.showBanner());
        }),
            ...
            return (
                ...
                (l.loginCMPlay = function (s) {
                    ...
                    c.Log.warn('loginCMPlay =>'),
                        ...
                        c.NetworkUtil.request({
                            ...
                            success: function (t) {
                                var e;
                                if ((e = 'string' == typeof t ? JSON.parse(t) : t) && 0 == e.status && e.result) {
                ...
                (l.setStorage = function (t) {
                    if (!c.Global.data.mCMPlayerId || !c.Global.data.mCMToken)
                        return c.Log.error('setStorage:: Missing playerId/token'), void (t.fail && t.fail(null));
                    var e = l.getServerURL() + 'warty/storage/set';
                    l.postRequest(e, t.kvDatas, t.success, t.fail);
                }),
                (l.getStorage = function (t) {
                    if (!c.Global.data.mCMPlayerId || !c.Global.data.mCMToken)
                        return c.Log.error('getStorage:: Missing playerId/token'), void (t.fail && t.fail(null));
                    var e = l.getServerURL() + 'warty/storage/get';
                    l.postRequest(e, t.keys, t.success, t.fail);
                }),
                (l.delStorage = function (t) {
                    if (!c.Global.data.mCMPlayerId || !c.Global.data.mCMToken)
                        return c.Log.error('delStorage:: Missing playerId/token'), void (t.fail && t.fail(null));
                    var e = l.getServerURL() + 'warty/storage/del';
                    l.postRequest(e, t.keys, t.success, t.fail);
                }),
                (l.getServerTime = function (e) {
                    if (!c.Global.data.mCMPlayerId || !c.Global.data.mCMToken)
                        return c.Log.error('delStorage:: Missing playerId/token'), void (e.fail && e.fail(null));
                    var t = l.getServerURL() + 'warty/storage/get';
                    l.postRequest(
                        t,
                        ['_timestamp_'],
                        function (t) {
                            t && void 0 !== t.timestamp ? e.success && e.success(t.timestamp) : e.fail && e.fail(null);
                        },
                        e.fail,
                    );
                }),
            ...
            return (
                ...
                (t.prototype.startRewardVideo = function (t) {
                    return window.RewardVideo && window.RewardVideo.startRewardVideo
                        ? ((e.Global.data.mRewardVideoCallback = t), window.RewardVideo.startRewardVideo(), !0)
                        : (t && t(!1), !1);
                }),
    ...
    (function (t) {
        var e = (function () {
            function t() {
                (this.mVideoNative = void 0), (this.mVideoCallback = void 0), (this.mIsOnReward = !1);
            }
            return (
                (t.prototype.init = function (t) {
                    var e,
                                ...
                                var o = new a.NATIVE.rewardVideoAd(function (t) {
                                    ...
                                    e &&
                                        ...
                                        ('onADClose' === e.data.action
                                            ? (n.mVideoCallback && n.mVideoCallback(n.mIsOnReward), o.loadAd())
                ...
                (t.prototype.startRewardVideo = function (t) {
                    return this.mVideoNative
                        ? ((this.mIsOnReward = !1), (this.mVideoCallback = t), this.mVideoNative.showAd(), !0)
                        : (t && t(!1), !1);
                }),
                (t.prototype.showBanner = function () {
                    return !1;
                                    ...
                                    if (e && e.back_adpos) {
                                        ...
                                        'onRewardADShow' == o
                                            ...
                                            : 'onRewardADClose' == o &&
                                              ...
                                              (n.Global.data.mRewardVideoCallback(this.isRewardVideoComplete),
    ...
    (function (n) {
        var t = (function () {
            ...
            return (
                (t.prototype.init = function (t) {
                    var e = this;
                    n.SysUtil.loadSDKScript('https://game-cdn.poki.com/scripts/v2/poki-sdk.js', !1, function () {
                    ...
                    return window.PokiSDK
                        ? (n.Log.warn('POKIAd::startRewardVideo => invoke'),
                          ...
                          PokiSDK.rewardedBreak().then(function (t) {
                              t
                                  ? (n.Log.log('POKIAd::startRewardVideo => reward'), e && e(!0))
                                  : (n.Log.log('POKIAd::startRewardVideo => unrewarded'), e && e(!1)),
                                  o.onActivityShow();
                          }),
                          !0)
                        : (n.Log.error('POKIAd::startRewardVideo => Missing PokiSDK env'), e && e(!1), !1);
                }),
                (t.prototype.showBanner = function () {
                    return window.PokiSDK
                        ...
                        window.PokiSDK
                            ? (this.onActivityHide(),
                              PokiSDK.commercialBreak()
                                  .then(function () {
                                      n.Log.log('POKIAd::showInterstitialAd => commercialBreak finish'),
                                          t && t(!0),
                                          e.onActivityShow();
                                  })
                                  .catch(function () {
                                      n.Log.log('POKIAd::showInterstitialAd => commercialBreak catch'),
                                          t && t(!1),
                                          e.onActivityShow();
                                  }))
                            : (n.Log.error('POKIAd::showInterstitialAd => Missing PokiSDK env'), t && t(!1)),
                        !1
                    );
                }),
                ...
                (t.prototype.happyTime = function (t) {
                    window.PokiSDK && (t <= 0 || (1 < t && (t = 1), PokiSDK.happyTime(t)));
                }),
                    ...
                    return window.qtt_help
                        ? (o.Log.warn('QTTAd::startRewardVideo => invoke'),
                          ...
                          window.qtt_help.ad.showVideo(
                              function (t) {
                                  1 == t
                                      ? (o.Log.log('QTTAd::startRewardVideo => endedCallback rewarded'), e && e(!0))
                                      : (o.Log.log('QTTAd::startRewardVideo => endedCallback unrewarded for ' + t),
                                        e && e(!1)),
                                      window.onActivityShow && window.onActivityShow();
                              },
                              {
                          ...
                          !0)
                        : (o.Log.error('QTTAd::startRewardVideo => Missing qtt_help env'), e && e(!1), !1);
                }),
                (t.prototype.showBanner = function () {
                    return window.qtt_help
                        ? (o.Log.warn('QTTAd::showBanner => invoke'), window.qtt_help.ad.showBanner(), !0)
                        : (o.Log.error('QTTAd::showBanner => Missing qtt_help env'), !1);
                }),
                (t.prototype.hideBanner = function () {
                    return window.qtt_help
                        ? (o.Log.warn('QTTAd::hideBanner => invoke'), window.qtt_help.ad.hideBanner(), !0)
                ...
                (t.prototype.showInteractAd = function (t) {
                    return window.qtt_help
                        ? (o.Log.warn('QTTAd::showInteractAd => invoke'),
                          ...
                          t && t(!0),
                          !0)
                        : (o.Log.error('QTTAd::showInteractAd => Missing qtt_help env'), t && t(!1), !1);
                }),
                (t.prototype.showOpenGameAd = function () {
                    return !1;
                }),
                ...
                (t.prototype.startRewardVideo = function (e) {
                    return window.qttGame
                        ? (o.Log.warn('QTTAd::startRewardVideo => invoke'),
                          ...
                          !0)
                        : (o.Log.error('QTTAd::startRewardVideo => Missing qttGame env'), e && e(!1), !1);
                }),
                (t.prototype.showBanner = function () {
                    return window.qttGame
                        ? (o.Log.warn('QTTAd::showBanner => invoke'), window.qttGame.showBanner(), !0)
                        : (o.Log.error('QTTAd::showBanner => Missing qttGame env'), !1);
                }),
                (t.prototype.hideBanner = function () {
                    return window.qttGame
                        ? (o.Log.warn('QTTAd::hideBanner => invoke'), window.qttGame.hideBanner(), !0)
                ...
                (t.prototype.showInteractAd = function (t) {
                    return window.qttGame
                        ? (o.Log.warn('QTTAd::showInteractAd => invoke'),
                          ...
                          t && t(!0),
                          !0)
                        : (o.Log.error('QTTAd::showInteractAd => Missing qttGame env'), t && t(!1), !1);
                }),
                (t.prototype.showOpenGameAd = function () {
                    return !1;
                }),
        ...
        var t = (function () {
            ...
            return (
                ...
                (t.prototype.createSIAOld = function () {
                    return e.Global.public.game_page == e.PAGE.BRICK_BALL ? new e.SIAdOld() : new e.SIAdOld_ima();
                }),
                ...
                (t.prototype.isSIVerNew = function () {
                    var t = window.shareitBridge.syncInvoke('PayPhoneFare', 'getDeviceInfo', '');
        ...
        var t = (function () {
            ...
            return (
                ...
                (t.prototype.startRewardVideo = function (t) {
                    ...
                    return console.log('GameAd::startRewardVideo => ' + e), this.onActivityShow(), !0;
                }),
                (t.prototype.showInterstitialAd = function (t) {
                    if (!window.shareitBridge || !this.canShowAd(this.inerstitialJson))
                        return (
                            o.Log.error('ShareIt::showInterstitialAd => show Interstitial error'),
                            t && t(!1),
                    ...
                    return console.log('GameAd::showInterstitialAd => ' + e), this.onActivityShow(), !1;
                }),
                (t.prototype.canShowAd = function (t) {
                    var e = window.shareitBridge.syncInvoke('GameAd', 'canShowAd', JSON.stringify(t));
        ...
        var t = (function () {
            ...
            return (
                (n.prototype.init = function (t) {
                    a.SysUtil.loadSDKScript('https://imasdk.googleapis.com/js/sdkloader/ima3.js', !1, function () {
                ...
                (n.prototype.createContainer = function () {
                    ...
                    (this.BigadContainer = document.createElement('DIV')),
                        ...
                        document.getElementsByTagName('body')[0].appendChild(this.BigadContainer);
    ...
    (function (n) {
        var t = (function () {
            ...
            return (
                (t.prototype.init = function (t) {
                    n.SysUtil.loadSDKScript('https://imasdk.googleapis.com/js/sdkloader/ima3.js', !1, function () {
                ...
                (t.prototype.playAds = function () {
                    if (this.adsManager) {
                        ...
                        try {
                            ...
                            this.adsManager.init(t, e, google.ima.ViewMode.NORMAL), this.adsManager.start();
                        } catch (t) {
                ...
                (t.prototype.onAdEvent = function (t) {
                    ...
                    switch (t.type) {
                        ...
                        case google.ima.AdEvent.Type.USER_CLOSE:
                            o.intervalTimer && (clearInterval(o.intervalTimer), (o.intervalTimer = null)),
                                (o.BigadContainer.style.display = 'none');
                    }
                }),
                ...
                (t.prototype.onContentPauseRequested = function () {
                    this.videoContent.pause(), n.Log.error('SIAdOld_ima::onContentPauseRequested=> ');
                }),
                (t.prototype.onContentResumeRequested = function () {
                    this.videoContent.play(), n.Log.error('SIAdOld_ima::onContentResumeRequested=> ');
                }),
                (t.prototype.showBanner = function () {
                    return !1;
                }),
        ...
        var t = (function () {
            ...
            return (
                ...
                (e.detect = function () {
                    ...
                    return 'qtt' != t ||
                        ('default' == o.getQueryString('ticket', 'default') && !/qukan/i.test(navigator.userAgent))
            ...
            n = (function () {
                ...
                return (
                    ...
                    (d.report = function (n, a, i) {
                        ...
                        d.httpRequest({
                            ...
                            success: function (t, e) {
                                ...
                                e
                                    ? 1 == d.parseData(e)
                                        ? (l.Log.log('InfocImpl::[' + n + '] ' + s + ' ' + (o - r) + 'ms => SUCCESS'),
                                          setTimeout(function () {
                                    ...
                                    : 0 < i
                                    ? (l.Log.log(
                                          'InfocImpl::[' + n + '] ' + s + ' ' + (o - r) + 'ms ' + i + ' => FAILED2',
                                      ),
                                      l.CMInfocCache.push(n, a, i - 1))
                                    : l.Log.log(
                                          'InfocImpl::[' +
                            ...
                            fail: function (t, e) {
                                0 < i
                                    ? (l.Log.error('InfocImpl::table:' + n + ' code:' + t + ' => FAILED3'),
                                      l.CMInfocCache.push(n, a, i - 1))
                                    : l.Log.error('InfocImpl::table:' + n + ' code:' + t + ' => FAILED3 DROP');
                            },
                        });
                    }),
                    (d.httpRequest = function (e, t) {
                        ...
                        for (var n in (o.open(e.method, e.url), e.header)) o.setRequestHeader(n, e.header[n]);
                                    ...
                                    if (e.success)
                                        if ('json' == e.dataType)
                                            try {
                                                ...
                                                e.success(o.status, o.responseText, o.getAllResponseHeaders());
                                            }
                                        else e.success(o.status, o.responseText, o.getAllResponseHeaders());
                                } else 1 < t ? d.httpRequest(e, t - 1) : e.fail && e.fail(o.status, o.responseText);
                        }),
        ...
        var e = (function () {
            ...
            return (
                (t.prototype.set = function (t, e) {
                    if (null == t || null == t) throw new Error('ERROR: key cannot be null or undefined!');
                    if (null == e || null == e) throw new Error('ERROR: value cannot be null or undefined!');
                    return this.mMap.put(t, e), this;
                }),
                (t.prototype.buildDataString = function (t) {
                    for (
                        var e = 'business_index=' + t + '&', o = this.mMap.size(), n = this.mMap.getPairs(), a = 0;
                        a < o;
                        a++
                    ) {
                        var i = n[a];
            ...
            return (
                (t.report = function (t) {
                    o.Global.public.game_page < 1 &&
                        o.Log.error('###### ERROR: Invoke CMPlay.init before reportAction !!! ######');
                    var e = new o.CMInfoc();
            ...
            return (
                (t.report = function (t, e, o) {
                    a.Global.public.game_page < 1 &&
                        a.Log.error('###### ERROR: Invoke CMPlay.init before reportAction !!! ######');
                    var n = new a.CMInfoc();
            ...
            return (
                ...
                (t.prototype.login = function (i) {
                    ...
                    !t.gameToken || t.gameToken.length < 10
                        ? (r.Log.error('CMPlay::Missing gameToken!!!'), i && i(!1, void 0, void 0, 0, 0))
                ...
                (t.prototype.getAppID = function () {
                    if (window.GameJs && window.GameJs.getAppID) return window.GameJs.getAppID();
                }),
                (t.prototype.getUID = function () {
                    return window.GameJs && window.GameJs.getUID ? window.GameJs.getUID() : r.Platform.getXAID();
                }),
                (t.prototype.getGameToken = function () {
                    return window.GameJs && window.GameJs.getGameToken ? window.GameJs.getGameToken() : '';
                }),
                ...
                (t.prototype.getStroageList = function (t, e) {
                    r.CMService.getStorage({
                        keys: t,
                        success: function (t) {
                            t && t.result && t.result.data ? e && e(t.result.data) : e && e(void 0);
                        },
                        fail: function (t) {
        ...
        var t = (function () {
            ...
            return (
                ...
                (t.prototype.login = function (i) {
                    ...
                    e == r.TokenState.TOKEN_READY
                        ? ((r.Global.data.mSystemInfo.gameToken = this.getGameToken()),
                          r.Log.log('GDT::login => gameToken:' + r.Global.data.mSystemInfo.gameToken),
                          r.CMService.loginCMPlay({
                              callback: function (t, e, o, n, a) {
                                  e && (r.Global.data.mCMPlayerId = e),
                                      o && (r.Global.data.mCMToken = o),
                        ...
                        ? (r.Log.error('GDT::login => failed'), i && i(!1, void 0, void 0, 0, 0))
                ...
                (t.prototype.getInterstitalAdCount = function () {
                    return Number(window.localStorage.getItem('gdt_interstital_ad_pref') || '0');
                }),
                ...
                return (
                    (t.prototype.init = function () {
                        ...
                        (this.mAd = new r.IQIYIAd()),
                            ...
                            this.mCMAPI.getGameToken(function (t) {
                                r.Log.warn('IQIYI::init => gameToken: ' + t), (e.mGameToken = t);
                            });
                    }),
                    (t.prototype.login = function (i) {
                        var t = this,
                        ...
                        e == r.TokenState.TOKEN_READY
                            ? ((r.Global.data.mSystemInfo.gameToken = this.getGameToken()),
                              r.Log.log('IQIYI::login => gameToken:' + r.Global.data.mSystemInfo.gameToken),
                              r.CMService.loginCMPlay({
                                  callback: function (t, e, o, n, a) {
                                      e && (r.Global.data.mCMPlayerId = e),
                                          o && (r.Global.data.mCMToken = o),
                            ...
                            : e == r.TokenState.TOKEN_FAILD
                            ? (r.Log.error('IQIYI::login => failed'), i && i(!1, void 0, void 0, 0, 0))
                    ...
                    (t.prototype.getInterstitalAdCount = function () {
                        return Number(window.localStorage.getItem('iqiyi_interstital_ad_pref') || '0');
                    }),
                    (t.prototype.plusInterstitalAdCount = function () {
                        var t = this.getInterstitalAdCount() + 1;
                    ...
                    (t.prototype.onGameMainStart = function () {
                        ...
                        if (this.isRoleCreated())
                            console.warn("IQIYI::onGameMainStart => skip post msg['role'] for created before");
                        else
                            try {
                                window.top.postMessage(
                                    {
                    ...
                    (t.prototype.onGameStart = function () {
                        try {
                            ...
                            console.error('IQIYI::onGameMainStart => ERROR:' + JSON.stringify(t.stack));
                        }
                    }),
                    (t.prototype.onGameStop = function () {}),
                    (t.prototype.onGameLevelPass = function (t) {}),
    ...
    (function (r) {
        var t = (function () {
            function t() {
                (this.mCMAPI = void 0), (this.mAd = void 0), (this.mPokiAd = void 0), (this.mGameToken = void 0);
            }
            return (
                (t.prototype.init = function () {
                    var e = this,
                ...
                (t.prototype.login = function (i) {
                    ...
                    e == r.TokenState.TOKEN_READY
                        ? ((r.Global.data.mSystemInfo.gameToken = this.getGameToken()),
                          r.Log.log('POKI::login => gameToken:' + r.Global.data.mSystemInfo.gameToken),
                          r.CMService.loginCMPlay({
                              callback: function (t, e, o, n, a) {
                                  e && (r.Global.data.mCMPlayerId = e),
                                      o && (r.Global.data.mCMToken = o),
                        ...
                        : e == r.TokenState.TOKEN_FAILD
                        ? (r.Log.error('POKI::login => failed'), i && i(!1, void 0, void 0, 0, 0))
                ...
                (t.prototype.getInterstitalAdCount = function () {
                    return Number(window.localStorage.getItem('poki_interstital_ad_pref') || '0');
                }),
                (t.prototype.plusInterstitalAdCount = function () {
                    var t = this.getInterstitalAdCount() + 1;
                ...
                (t.prototype.onGameLevelPass = function (t) {
                    ...
                    r.Log.warn('POKI::onGameLevelPass => happyIntensity:' + e), 0 < e && this.mPokiAd.happyTime(e);
                }),
    ...
    (function (r) {
        var a = ['a3BWxTMAGrA9', 'a3BWxSuGte5d', 'a3BWxX98eGXS', 'a3BWxY9DwmEm', 'a3CScC7gcqEu'],
            t = (function () {
                function t() {
                    (this.mCMAPI = void 0),
                        (this.mAd = void 0),
                ...
                return (
                    (t.prototype.init = function () {
                        ...
                        -1 != a.indexOf(this.mAppID) ? (this.mAd = new r.QTTV2Ad()) : (this.mAd = new r.QTTAd()),
                            this.mAd.init();
                        var o = {
                            platform: 'qtt',
                            ticket: e,
                    ...
                    (t.prototype.login = function (i) {
                        ...
                        e == r.TokenState.TOKEN_READY
                            ? ((r.Global.data.mSystemInfo.gameToken = this.getGameToken()),
                              r.Log.log('QTT::login => gameToken:' + r.Global.data.mSystemInfo.gameToken),
                              r.CMService.loginCMPlay({
                                  callback: function (t, e, o, n, a) {
                                      e && (r.Global.data.mCMPlayerId = e),
                                          o && (r.Global.data.mCMToken = o),
                            ...
                            : e == r.TokenState.TOKEN_FAILD
                            ? (r.Log.error('QTT::login => failed'), i && i(!1, void 0, void 0, 0, 0))
                    ...
                    (t.prototype.getInterstitalAdCount = function () {
                        return Number(window.localStorage.getItem('interstital_ad_pref') || '0');
                    }),
                    (t.prototype.plusInterstitalAdCount = function () {
                        var t = this.getInterstitalAdCount() + 1;
                    ...
                    (t.prototype.onGameLoadFinished = function () {
                        if (!this.loadComplete) {
                            ...
                            try {
                                ...
                                console.error('QTT:onGameLoadFinished => ERROR: ' + JSON.stringify(t.stack));
                            }
                        }
                    }),
                    (t.prototype.onGameMainStart = function () {
                        if (!this.loadingFinished) {
                            ...
                            try {
                                ...
                                console.error('QTT:onGameMainStart => ERROR: ' + JSON.stringify(t.stack));
                            }
                        }
                    }),
                    (t.prototype.onGameStart = function () {
                    ...
                    (t.prototype.onGameLevelPass = function (t) {
                        try {
                            window.qtt_help && window.qtt_help.task && window.qtt_help.task.completeTask(),
                                window.qttGame && window.qttGame.task && window.qttGame.task.completeTask();
                        } catch (t) {
                        ...
                        try {
                            ...
                            console.error('QTT:onGameLevelPass => ' + JSON.stringify(t.stack));
                        }
                    }),
                    t
                );
    ...
    (function (r) {
        ...
        var e = (function () {
            function t() {
                (this.mCMAPI = void 0), (this.mAd = void 0), (this.mShareItAd = void 0), (this.mGameToken = void 0);
            }
            return (
                (t.prototype.init = function (t) {
                    var e = this,
                    ...
                    (this.mAd = this.mShareItAd = new r.SIAd()),
                        this.mAd.init(t),
                        (this.mCMAPI = new r.CMAPI({
                            vmframe: 'https://h5game.zhhainiao.com/cmplaysdk/api/qiezikuaichuan.js',
                        ...
                        this.mCMAPI.getGameToken(function (t) {
                            r.Log.warn('ShareIt::init => gameToken: ' + t), (e.mGameToken = t);
                        });
                }),
                (t.prototype.login = function (i) {
                    var t = this,
                    ...
                    e == r.TokenState.TOKEN_READY
                        ? ((r.Global.data.mSystemInfo.gameToken = this.getGameToken()),
                          r.Log.log('ShareIt::login => gameToken:' + r.Global.data.mSystemInfo.gameToken),
                          r.CMService.loginCMPlay({
                              callback: function (t, e, o, n, a) {
                                  e && (r.Global.data.mCMPlayerId = e),
                                      o && (r.Global.data.mCMToken = o),
                        ...
                        : e == r.TokenState.TOKEN_FAILD
                        ? (r.Log.error('ShareIt::login => failed'), i && i(!1, void 0, void 0, 0, 0))
                ...
                (t.prototype.getInterstitalAdCount = function () {
                    return Number(window.localStorage.getItem('qz_interstital_ad_pref') || '0');
                }),
                (t.prototype.plusInterstitalAdCount = function () {
                    var t = this.getInterstitalAdCount() + 1;
            ...
            return (
                ...
                (t.prototype.stopBGM = function () {
                    window.Laya
                        ...
                        : window.cc
                        ? null != this.mBGM.id && (cc.audioEngine.stop(this.mBGM.id), (this.mBGM.id = void 0))
                        : window.egret
                        ? null != this.mBGM.id && (this.mBGM.id.stop(), (this.mBGM.id = void 0))
                        : console.warn('AudioImpl::stopBGM => unsupported');
                }),
                (t.prototype.pauseBGM = function () {
                    if (window.Laya) this.mBGM.id instanceof Laya.SoundChannel && (t = this.mBGM.id).pause();
                    else if (window.cc) null != this.mBGM.id && cc.audioEngine.pause(this.mBGM.id);
                    else if (window.egret) {
                        if (null != this.mBGM.id) {
                            var t = this.mBGM.id;
                            (this.mBGM.pausePos = t.position), t.stop(), (this.mBGM.id = void 0);
                        }
                        ...
                        ? this.mBGM.src &&
                          ...
                          this.getEgretSound(this.mBGM.src, function (t) {
                              if (t) {
                                  ...
                                  (e.volume = o.mBGM.volume), (o.mBGM.id = e), (o.mBGM.pausePos = -1);
                              }
                          })
                            ...
                            : void (window.egret
                                  ? this.getEgretSound(t, function (t) {
                                        if (t) {
                                            ...
                                            e.volume = n;
                                            var o = function () {
                                                e.removeEventListener(egret.Event.SOUND_COMPLETE, o, a),
                                                    e.stop(),
                                                    (e = void 0);
                                            };
    ...
    (function (s) {
        var d, t;
        ((t = d = s.TokenState || (s.TokenState = {}))[(t.TOKEN_REQUESTING = 0)] = 'TOKEN_REQUESTING'),
        ...
        var e = (function () {
            function t(t) {
                ...
                (this.isRequesting = !1),
                    ...
                    (this.tokenState = d.TOKEN_REQUESTING),
                    (this.mReqTokenCBList = []),
                    (this.mIsAPILogin = null != this.mLoginType && null != this.mLoginParams),
                    (this.mData = new s.CMAPIData(this.mAppId, t.uuid)),
                    s.SysUtil.loadSDKScript(t.vmframe, !1, function () {
                        0 < e.mReqTokenCBList.length
                            ? (s.Log.warn('CMAPI::loadSDKScript => vmframe is Ready, process mReqTokenCBList'),
            ...
            return (
                ...
                (t.prototype.getGameToken = function (t) {
                    this.mIsAPILogin ? this._getLoginGameToken(t) : this._getAnonymousGameToken(t);
                }),
                (t.prototype._sign = function (t) {
                    try {
                        return window.sign(t);
                    } catch (t) {
                        s.Log.error('CMAPI::sign => ERROR ' + t.message), s.Log.error(JSON.stringify(t.stack));
                    }
                }),
                ...
                (t.prototype._getAnonymousGameToken = function (t) {
                    ...
                    if (e && 5 < e.length) {
                        ...
                        s.Log.warn('CMAPI::_getAnonymousGameToken => NOT FOUND gameToken'), this._requestGameToken(t);
                }),
                (t.prototype._requestGameToken = function (t) {
                    var r = this;
                    if ((t && this.mReqTokenCBList.indexOf(t) < 0 && this.mReqTokenCBList.push(t), window.sign))
                        if (this.isRequesting) s.Log.warn('CMAPI::_requestGameToken => wait for running');
                        else {
                            ...
                            this._requestToken(e, n, a, function (t, e) {
                                ...
                                if (t && e.user_info && void 0 !== e.user_info.uid) {
                                    o = e.game_tokens && e.game_tokens.cmcp && e.game_tokens.cmcp.game_token;
    ...
    (function (a) {
        ...
        var o = '_cmapi_version_',
            t = (function () {
                function t(t, e) {
                    switch (
                        ((this.mDataAPI = void 0), (this.platform = void 0), (this.platform = t), this.getDataVersion())
                    ) {
                        case 3:
                        ...
                        case 1:
                            ...
                            break;
                        default:
                            this.mergeData(t, e), (this.mDataAPI = this.detectAndGetDataAPI(t, e));
                    }
                }
                return (
                    ...
                    (t.prototype.mergeData = function (t, e) {
                        for (
                            ...
                            if (null == i)
                                for (var r = 0; a.oldKeys instanceof Array && r < a.oldKeys.length; r++)
                                    if (null != (i = window.localStorage.getItem(a.oldKeys[r]) || void 0)) {
                                        window.localStorage.setItem(a.newKey, i),
                                            window.localStorage.removeItem(a.oldKeys[r]),
                                            console.error('CMAPIData:: merge[' + a.newKey + '] => [' + i + ']');
                                        break;
                                    }
                        }
                    }),
                    ...
                    (t.prototype.getLastUpdateSec = function () {
                        return Number(window.localStorage.getItem(this.platform + '_cmapi_timestamp_') || '0');
                    }),
                    (t.prototype.setLastUpdateSec = function (t) {
                        window.localStorage.setItem(this.platform + '_cmapi_timestamp_', t + a.EMPTY_STRING);
                    }),
                    (t.prototype.getDataVersion = function () {
                        return Number(window.localStorage.getItem(this.platform + o) || '0');
                    }),
                    t
                );
            })();
        ...
        var n = (function () {
                function t(t) {
                    window.localStorage.setItem(t + o, '1'), a.Global.isOutputDebug && console.error('DataV1 => ');
                }
                return (
            ...
            r = (function () {
                ...
                return (
                    (t.prototype.getItem = function (t, e) {
                        return window.localStorage.getItem(this.platform + t + this.userid) || e;
                    }),
                    (t.prototype.setItem = function (t, e) {
                        return window.localStorage.setItem(this.platform + t + this.userid, e);
                    }),
                    t
                );
            })();
        ...
        function d(t, e) {
            ...
            for (
                ...
                for (var l = n, c = a, u = i, g = r, p = s, m = 0; m < 80; m++) {
                    o[m] = m < 16 ? t[d + m] : v(o[m - 3] ^ o[m - 8] ^ o[m - 14] ^ o[m - 16], 1);
                    var h = S(
                        S(
                            v(n, 5),
                            ((y = a),
                        ...
                        S(
                            S(s, o[m]),
                            (f = m) < 20 ? 1518500249 : f < 40 ? 1859775393 : f < 60 ? -1894007588 : -899497514,
                        ),
                    );
                    (s = r), (r = i), (i = v(a, 30)), (a = n), (n = h);
                }
                (n = S(n, l)), (a = S(a, c)), (i = S(i, u)), (r = S(r, g)), (s = S(s, p));
            }
            var f, w, y, A, I;
        ...
        t.hex_hmac_sha1 = function (t, e) {
            return (function (t) {
                for (var e, o = '0123456789abcdef', n = '', a = 0; a < t.length; a++)
                    (e = t.charCodeAt(a)), (n += o.charAt((e >>> 4) & 15) + o.charAt(15 & e));
                return n;
            })(
                (function (t, e) {
                    var o = s(t);
    ...
    (function (t) {
        var e = (function () {
            ...
            return (
                ...
                (e.log = function (t) {
                    e.isEnable(e.LEVEL_LOG) && ('string' == typeof t ? console.log('[CMPlay] ' + t) : console.log(t));
                }),
                (e.warn = function (t) {
                    e.isEnable(e.LEVEL_WARN) &&
                        ('string' == typeof t ? console.warn('[CMPlay] ' + t) : console.warn(t));
                }),
                (e.error = function (t) {
                    e.isEnable(e.LEVEL_ERROR) &&
                        ('string' == typeof t ? console.error('[CMPlay] ' + t) : console.error(t));
                }),
                (e.LEVEL_LOG = 0),
                (e.LEVEL_WARN = 1),
                (e.LEVEL_ERROR = 2),
        ...
        var t = (function () {
            ...
            return (
                ...
                (a.httpRequest = function (t, o) {
                    ...
                    for (var e in (a.open(t.method, t.url), t.header)) a.setRequestHeader(e, t.header[e]);
                        ...
                        if (4 == a.readyState)
                            if (200 == a.status) {
                                if (t.success)
                                    ...
                                    } else t.success(a.status, a.responseText, a.getAllResponseHeaders());
                            } else 1 < o ? n.httpRequest(t, o - 1) : t.fail && t.fail(a.status, a.responseText);
                    }),
                        'object' == typeof t.data ? a.send(JSON.stringify(t.data)) : a.send(t.data);
                }),
                a
            );
        })();
    ...
    (window.getQueryString = function (t, e) {
        ...
        if (o && -1 !== o.indexOf('?') && (o = o.substr(1) || window.location.hash.split('?')[1])) {
            var n = new RegExp('(^|&)' + t + '=([^&]*)(&|$)'),
                a = o.match(n);
    ...
    (window.getPathVersion = function () {
        ...
        if (t) {
            var e = new RegExp('(v20[0-9]+)'),
                o = t.match(e);
            if (o && 0 < o.length && o[0] && 11 <= o[0].length && 'v20' == o[0].substr(0, 3)) {
                var n = o[0];
                return (
                    Number(n.substr(1, 4)) -
                    2018 +
