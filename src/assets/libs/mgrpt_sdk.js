...
(function (n) {
    var t = (function () {
        ...
        return (
            ...
            (e.init = function (t) {
                e.getInstance(),
                    e.sInst.mbInited ||
                        ...
                        (e.sInst.mPlatformInfo = n.PlatformProxy.getInstance().getPlatformInfo()),
            ...
            (e.setPlayerId = function (t) {
                e.getInstance(), e.sInst.mbInited && e.sInst.mInfocEnvCfg && (e.sInst.mInfocEnvCfg.mPlayerId = t);
            }),
            (e.getPlayerId = function () {
                return e.getInstance(), e.sInst.mbInited && e.sInst.mInfocEnvCfg ? e.sInst.mInfocEnvCfg.mPlayerId : '';
            }),
            (e.setAuthorizeFlag = function () {
                e.getInstance(), e.sInst.mbInited && e.sInst.mInfocEnvCfg && (e.sInst.mInfocEnvCfg.mAuthorization = 1);
            }),
            (e.getShareTag = function () {
                return (
                    e.getInstance(),
                    e.sInst.mbInited
                        ? (e.sInst.mShareTag || (e.sInst.mShareTag = new n.MGShareTag()), e.sInst.mShareTag)
                        : null
                );
            }),
            (e.getCroProTag = function () {
                return (
                    e.getInstance(),
                    e.sInst.mbInited
                        ? (e.sInst.mCroProTag || (e.sInst.mCroProTag = new n.MGCroProTag()), e.sInst.mCroProTag)
                        : null
                );
            }),
        ...
        var t = (function () {
            ...
            return (
                (e.prototype.init = function () {
                    this.fetchLocal()
                        ? r.Log.i(this.TAG, 'fetch cross promotion tag from cache: ' + this.mCroProTag)
                        : (this.parse()
                              ? r.Log.i(this.TAG, 'parse cross promotion tag from launch params: ' + this.mCroProTag)
                              : this.create(),
                ...
                (e.prototype.create = function () {
                    if (!this.mCroProTag) {
                        var t = r.MGCmnRptModule.getInfocEnvCfg(),
                            ...
                            n = t.game_id;
                        (this.mCroProTag = e + ',' + n),
                            r.Log.i(this.TAG, 'cross promotion tag created: ' + this.mCroProTag);
                    }
                }),
                (e.prototype.fetchLocal = function () {
                    return (
                        (this.mCroProTag = r.PlatformProxy.getInstance().getStorage(e.KEY_CROSS_PROMOTION_TAG)),
                        r.Log.i(this.TAG, 'cache cropro tag: ' + this.mCroProTag),
                        this.mCroProTag && 0 < this.mCroProTag.length
                    );
                }),
                (e.prototype.saveLocal = function (t) {
                    r.PlatformProxy.getInstance().setStorage(e.KEY_CROSS_PROMOTION_TAG, t),
                        r.Log.i(
                            this.TAG,
                            'cross promotion tag saved to local cache: ' + e.KEY_CROSS_PROMOTION_TAG + ':' + t,
                        );
                }),
    ...
    (function (n) {
        var t = (function () {
            ...
            return (
                (t.prototype.getPlatformType = function () {
                    return (
                        console.log('MGRPT_DEBUG', 'GameEngine4None.getPlatformType() enter.'),
                        this.isPlatformTT()
                ...
                (t.prototype.getLocalItem = function (t) {
                    if (this.isPlatformWX()) return n.PlatformProxy.getInstance().getStorage(t);
                }),
                (t.prototype.removeLocalItem = function (t) {
                    if (this.isPlatformWX()) return n.PlatformProxy.getInstance().delStorage(t);
                }),
                (t.prototype.clear = function () {}),
                t
            );
            ...
            return (
                (n.getPlatformType = function () {
                    return n.mPlatformTypeCur
                        ? n.mPlatformTypeCur
                        : (n.prepareGECur(),
                          n.mGameEngineCur ? (n.mPlatformTypeCur = n.mGameEngineCur.getPlatformType()) : '');
                }),
                (n.isPlatformWX = function () {
                    return n.prepareGECur(), !!n.mGameEngineCur && n.mGameEngineCur.isPlatformWX();
                }),
                (n.isPlatformQQ = function () {
                    return n.prepareGECur(), !!n.mGameEngineCur && n.mGameEngineCur.isPlatformQQ();
                }),
                (n.isPlatformWeb = function () {
                    return n.prepareGECur(), !!n.mGameEngineCur && n.mGameEngineCur.isPlatformWeb();
                }),
                (n.isPlatformFB = function () {
                    return n.prepareGECur(), !!n.mGameEngineCur && n.mGameEngineCur.isPlatformFB();
                }),
                (n.setLocalItem = function (t, e) {
                    n.prepareGECur(), n.mGameEngineCur && n.mGameEngineCur.setLocalItem(t, e);
                }),
                (n.getLocalItem = function (t) {
                    n.prepareGECur(), n.mGameEngineCur && n.mGameEngineCur.getLocalItem(t);
                }),
                (n.removeLocalItem = function (t) {
                    n.prepareGECur(), n.mGameEngineCur && n.mGameEngineCur.removeLocalItem(t);
                }),
                (n.clear = function () {
            ...
            n = (function () {
                function a() {
                    (this.mMap = new i.Dictionary()),
                        i.ENUMPLATFORM.PLATFORM_FB === i.PlatformChecker.getPlatformType() &&
                ...
                return (
                    ...
                    (a.reportInfocImpl = function (r, o) {
                        var t = a.getCommonData(),
                            e = a.getHost() + '/?' + t + '&' + o,
                            n = encodeURI(e);
                        i.Log.i('MGB_DEBUG', 'before call PlatformProxy.getInstance().request'),
                            i.PlatformProxy.getInstance().request({
                                ...
                                success: function (t, e) {
                                    if (e)
                                        ...
                                        i.Log.e('Infoc:: error(' + r + ')'), i.InfocCache.pushRequest(r, o, Date.now());
                                },
                                fail: function (t, e) {
                    ...
                    (a.prototype.buildDataString = function (t) {
                        for (
                            var e = 'business_index=' + t + '&', n = this.mMap.size(), r = this.mMap.getPairs(), o = 0;
                            o < n;
                            o++
                        ) {
                            var a = r[o];
                    ...
                    (a.prototype.report = function () {
                        ...
                        r && r.mPlayerId
                            ...
                            : (i.InfocCache.pushRequest(t, e, n),
                              i.Log.e(a.TAG, 'after InfocCache.pushRequest, no playerId. info:' + e));
                    }),
                    (a.isNewUser = function () {
                        ...
                        if (!e || e.length <= 0)
                            i.PlatformProxy.getInstance().setStorage(o, t.getTime() + ''), (a.isNewUserFlag = 1);
                        else {
            ...
            t = (function () {
                ...
                return (
                    ...
                    (t.shiftRequest = function () {
                        var t = o.shift();
                        return t && r.Log.i('InfoCache.shiftRequest:: (' + t.id + ') => ' + t.info), t;
                    }),
                    t
                );
            })();
        ...
        var t = (function () {
            ...
            return (
                (f.getSubChannel = function (t, e) {
                    ...
                    if (
                        ((this.mLocalSubChannel = c.PlatformProxy.getInstance().getStorage(f.KEY_GAME_SUB_CHANNEL)),
                ...
                (f.getChannelByExtra = function (t) {
                    return t && t.query && t.query.channel && t.scene ? t.query.channel : null;
                }),
                (f.getChannelByOther = function (t) {
                    return t && t.path && 'index' != t.path && t.path.startsWith('6') ? t.path : null;
                }),
                (f.getChannelByAppId = function (t) {
                    return t && t.referrerInfo && t.referrerInfo.appId ? t.referrerInfo.appId : null;
                }),
                ...
                (f.getChannelByAdsource = function (t) {
                    return t && t.referrerInfo && t.referrerInfo.extraData && t.referrerInfo.extraData.adsource
        ...
        var t = (function () {
            ...
            return (
                ...
                (t.prototype.fillInfocEnvCfg = function (t) {
                    return (
                        t &&
                            ...
                            t.sub_channel ||
                                (t.sub_channel = i.SubChannelHelper.getSubChannel(this.getLaunchParameter()))),
                        t
                    );
                }),
                (t.prototype.getLaunchParameter = function () {
                    ...
                    return (
                        FBInstant.getEntryPointData() ||
                            i.Log.w(this.TAG, 'no launch options associated with current entry point'),
                        t
                    );
                }),
                (t.prototype.request = function (r, t) {
                    ...
                    for (var e in (a.open(r.method, r.url), r.header)) a.setRequestHeader(e, r.header[e]);
                    (a.onreadystatechange = function () {
                        if (a.readyState == XMLHttpRequest.DONE)
                            if (
                                ...
                                if ((i.Log.i(o.TAG, 'facebook request, succeed:', a.responseText), r.success)) {
                                    var e = a.status,
                                ...
                                i.Log.i(o.TAG, 'facebook request, failed:', a.responseText),
                                    1 < t ? o.request(r, t - 1) : r.fail && r.fail(a.status, a.responseText);
                    }),
        ...
        var t = (function () {
            ...
            return (
                    ...
                    var t = (function () {
                        ...
                        return (
                            ...
                            (t.prototype.onEnterBackground = function (t) {
                                u.Log.i(
                                    'MGB.PlatformImpl4QQ',
                                    'BK.Game.onEnterbackground, statusInfo:' + JSON.stringify(GameStatusInfo),
                                ),
                            ...
                            (t.prototype.onEnterForeground = function (t) {
                                u.Log.i(
                                    'MGB.PlatformImpl4QQ',
                                    'BK.Game.onEnterforeground, statusInfo:' + JSON.stringify(GameStatusInfo),
                                ),
                                ...
                                if (o) {
                                    ...
                                    if (!(a <= 0 || a >= o.length)) {
                                        ...
                                        i == u.MGShareTag.KEY_LEVEL
                                            ? (t.setLevel(Number(s)), u.Log.i('MGRPT_DEBUG', '[level]:' + s))
                                            : i == u.MGShareTag.KEY_SUPER
                                            ? (t.setSuper(s), u.Log.i('MGRPT_DEBUG', '[super]:' + s))
                                            : i == u.MGShareTag.KEY_ORIGIN &&
                                              (t.setOrigin(s), u.Log.i('MGRPT_DEBUG', '[origin]:' + s));
                                    }
                                }
                            }
                    }
                ...
                (e.prototype.fillInfocEnvCfg = function (t) {
                    return (
                        t &&
                            ...
                            t.sub_channel ||
                                (t.sub_channel = u.SubChannelHelper.getSubChannel(this.getLaunchParameter()))),
                        t
                    );
                }),
                (e.prototype.getLaunchParameter = function () {
                    ...
                    var e = GameStatusInfo.gameParam;
                    if (e) {
                        for (var n = {}, r = ('?' === e[0] ? e.substr(1) : e).split('&'), o = 0; o < r.length; o++) {
                            var a = r[o].split('=');
                ...
                (e.prototype.request = function (r, o) {
                    ...
                    if ((e.setHttpMethod(t), r.header)) for (var n in r.header) e.setHttpHeader(n, r.header[n]);
                    if (r.data) {
                ...
                (e.prototype.setStorage = function (t, e) {
                    BK.localStorage ? BK.localStorage.setItem(t, e) : u.GameEngineProxy.setLocalItem(t, e);
                }),
                (e.prototype.getStorage = function (t) {
                    return BK.localStorage ? BK.localStorage.getItem(t) : u.GameEngineProxy.getLocalItem(t);
                }),
                (e.prototype.delStorage = function (t) {
                    BK.localStorage ? BK.localStorage.removeItem(t) : u.GameEngineProxy.removeLocalItem(t);
                }),
                (e.getDataPath = function () {
                    BK.FileUtil.isFileExist(e.DATA_DIR) || BK.FileUtil.makeDir(e.DATA_DIR);
                ...
                (t.prototype.fillInfocEnvCfg = function (t) {
                    return (
                        t &&
                            ...
                            t.sub_channel ||
                                (t.sub_channel = n.SubChannelHelper.getSubChannel(this.getLaunchParameter()))),
                        t
                    );
                }),
                (t.prototype.getLaunchParameter = function () {
                    ...
                    if (t) {
                        ...
                        e &&
                            ...
                            e.hasOwnProperty(n.MGShareTag.KEY_SUPER) &&
                                (n.Log.i('MGRPT_DEBUG', 'pl_super:' + e.agent_upper), t.setSuper(e.agent_upper)),
                            e.hasOwnProperty(n.MGShareTag.KEY_ORIGIN) &&
                                (n.Log.i('MGRPT_DEBUG', 'pl_origin:' + e.agent_orign), t.setOrigin(e.agent_orign)));
                    }
                }),
                (t.prototype.parseCroProTag = function () {
                    return '';
            ...
            return (
                ...
                (t.prototype.fillInfocEnvCfg = function (t) {
                    return (
                        t &&
                            ...
                            t.sub_channel ||
                                (t.sub_channel = r.SubChannelHelper.getSubChannel(this.getLaunchParameter()))),
                        t
                    );
                }),
                (t.prototype.getLaunchParameter = function () {
                ...
                (t.prototype.login = function (t) {
                    wx.login({
                        ...
                        fail: function (t) {
                            r.Log.i('WX login failed. # code:' + t.code + ', errmsg:' + t.errMsg);
                        },
                    });
                }),
            ...
            return (
                ...
                (t.prototype.request = function (r, t) {
                    ...
                    (a.onreadystatechange = function () {
                        if (4 == a.readyState)
                            if (200 == a.status) {
                                if ((i.Log.i(o.TAG, 'request, succeed:', a.responseText), r.success)) {
                                    var e = a.status,
                                        n = a.getAllResponseHeaders();
                                    if ('json' == r.dataType)
                                        try {
        ...
        var t = (function () {
            ...
            return (
                ...
                (t.prototype.request = function (t, e) {
                    void 0 === e && (e = 3), null != this.mPlatformCur && this.mPlatformCur.request(t, e);
                }),
                (t.prototype.getPlatformInfo = function () {
                    return null == this.mPlatformCur ? null : this.mPlatformCur.getPlatformInfo();
                }),
                (t.prototype.setStorage = function (t, e) {
                ...
                (t.prototype.getStorage = function (t) {
                    return null == this.mPlatformCur ? null : this.mPlatformCur.getStorage(t);
                }),
                (t.prototype.delStorage = function (t) {
                    if (null == this.mPlatformCur) return null;
                ...
                (t.prototype.fillInfocEnvCfg = function (t) {
                    return null == this.mPlatformCur ? t : this.mPlatformCur.fillInfocEnvCfg(t);
                }),
                (t.prototype.fillShareTag = function (t) {
        ...
        var t = (function (t) {
            ...
            return (
                ...
                (r.prototype.getTableID = function () {
                    return o.ENUMPLATFORM.PLATFORM_FB === o.PlatformChecker.getPlatformType() ? 101 : 203;
                }),
                (r.report = function (t) {
                    var e = new r(),
        ...
        var t = (function (t) {
            ...
            return (
                ...
                (s.prototype.getTableID = function () {
                    return u.ENUMPLATFORM.PLATFORM_FB === u.PlatformChecker.getPlatformType() ? 102 : 208;
                }),
                (s.report = function (t, e, n, r) {
                    u.Log.i('MGRPT_DEBUG', 'minigame_common_ad.report enter. posId:' + t + ', action:' + e);
                    var o = new s(),
        ...
        var t = (function (t) {
            ...
            return (
                ...
                (u.prototype.getTableID = function () {
                    return e.ENUMPLATFORM.PLATFORM_FB === e.PlatformChecker.getPlatformType() ? 103 : 230;
                }),
        ...
        var t = (function (t) {
            ...
            return (
                ...
                (I.prototype.getTableID = function () {
                    return e.ENUMPLATFORM.PLATFORM_FB === e.PlatformChecker.getPlatformType() ? 104 : 232;
                }),
                (I.report = function (t, e, n, r, o, a, i, s, u, l, f, c, g, p, m, h, P, y) {
                    void 0 === o && (o = 0),
                        void 0 === a && (a = ''),
                        void 0 === i && (i = 0),
                        void 0 === s && (s = ''),
                ...
                (I.reportInOrder = function (t, e, n, r, o, a, i, s, u, l, f, c, g, p, m, h, P, y) {
                    void 0 === o && (o = 0),
                        void 0 === a && (a = 0),
                        void 0 === i && (i = 0),
                        void 0 === s && (s = 0),
        ...
        var t = (function (t) {
            ...
            return (
                ...
                (f.prototype.getTableID = function () {
                    return e.ENUMPLATFORM.PLATFORM_FB === e.PlatformChecker.getPlatformType() ? 105 : 233;
                }),
        ...
        var t = (function (t) {
            ...
            return (
                ...
                (l.prototype.getTableID = function () {
                    return e.ENUMPLATFORM.PLATFORM_FB === e.PlatformChecker.getPlatformType() ? 106 : 229;
                }),
    ...
    (function (e) {
        var t = (function (t) {
            ...
            return (
                __extends(u, t),
                (u.prototype.getTableID = function () {
                    return e.ENUMPLATFORM.PLATFORM_FB === e.PlatformChecker.getPlatformType() ? 107 : 228;
                }),
                (u.report = function (t, e, n, r, o, a, i) {
                    var s = new u();
                    s.set('scene_id', t),
    ...
    (function (e) {
        var t = (function (t) {
            ...
            return (
                __extends(r, t),
                (r.prototype.getTableID = function () {
                    return e.ENUMPLATFORM.PLATFORM_FB === e.PlatformChecker.getPlatformType()
                        ? (e.Log.e('MGRPT', 'minigame_common_time not support Facebook Platform Now!!!'), 0)
                        : 252;
                }),
    ...
    (function (e) {
        var t = (function (t) {
            ...
            return (
                __extends(l, t),
                (l.prototype.getTableID = function () {
                    return e.ENUMPLATFORM.PLATFORM_FB === e.PlatformChecker.getPlatformType() ? 108 : 231;
                }),
                (l.report = function (t, e, n, r, o, a, i, s) {
                    void 0 === r && (r = ''),
                        void 0 === o && (o = ''),
        ...
        var t = (function () {
            ...
            return (
                ...
                (n.prototype.init = function () {
                    ...
                    (this.mLevel = 1), (this.mPlayerId4Super = ''), (this.mPlayerId4Origin = t);
                }),
                ...
                (n.prototype.fetchFromLocalStorage = function () {
                    ...
                    if (
                        ...
                        (this.mPlayerId4Origin = r.PlatformProxy.getInstance().getStorage(n.KEY_ORIGIN)),
                        !this.mPlayerId4Origin)
                    ) {
                        r.Log.e(n.TAG, 'fetchFromLocalStorage [error] Origin PlayerId is empty.');
                        var e = r.MGCmnRptModule.getPlayerId();
                        this.mPlayerId4Origin = e;
                    }
                    (this.mPlayerId4Super = r.PlatformProxy.getInstance().getStorage(n.KEY_SUPER)),
                ...
                (n.prototype.saveShareTag = function () {
                    r.PlatformProxy.getInstance().setStorage(n.KEY_NOT1ST, 'dirtry'),
                        r.PlatformProxy.getInstance().setStorage(n.KEY_LEVEL, String(this.mLevel)),
                        r.PlatformProxy.getInstance().setStorage(n.KEY_SUPER, this.mPlayerId4Super),
                        r.PlatformProxy.getInstance().setStorage(n.KEY_ORIGIN, this.mPlayerId4Origin);
                }),
                (n.TAG = ''),
        ...
        var t = (function () {
            ...
            return (
                ...
                (r.formatDateTime = function () {
                    ...
                    if ((n.length < 2 && (n = '0' + n), r.length < 2 && (r = '0' + r), o.length < 3))
    ...
    (function (t) {
        ...
        function o(t) {
            for (var e, n = a ? '0123456789ABCDEF' : '0123456789abcdef', r = '', o = 0; o < t.length; o++)
                (e = t.charCodeAt(o)), (r += n.charAt((e >>> 4) & 15) + n.charAt(15 & e));
            return r;
        }
        ...
        function u(t, e) {
            ...
            for (n = 0; n < u.length; n++) u[n] = (t.charCodeAt(2 * n) << 8) | t.charCodeAt(2 * n + 1);
            for (; 0 < u.length; ) {
            ...
            for (var e, n, r = '', o = -1; ++o < t.length; )
                (e = t.charCodeAt(o)),
                    ...
                    e <= 127
                        ...
                        : e <= 65535
                        ? (r += String.fromCharCode(224 | ((e >>> 12) & 15), 128 | ((e >>> 6) & 63), 128 | (63 & e)))
                        : e <= 2097151 &&
        ...
        function g(t, e) {
            ...
            for (
                ...
                for (var f = o, c = a, g = i, p = s, m = u, h = 0; h < 80; h++) {
                    r[h] = h < 16 ? t[l + h] : I(r[h - 3] ^ r[h - 8] ^ r[h - 14] ^ r[h - 16], 1);
                    var P = T(
                        T(I(o, 5), y(h, a, i, s)),
                        T(
                            T(u, r[h]),
                            (n = h) < 20 ? 1518500249 : n < 40 ? 1859775393 : n < 60 ? -1894007588 : -899497514,
                        ),
                    );
                    (u = s), (s = i), (i = I(a, 30)), (a = o), (o = P);
                }
                (o = T(o, f)), (a = T(a, c)), (i = T(i, g)), (s = T(s, p)), (u = T(u, m));
            }
